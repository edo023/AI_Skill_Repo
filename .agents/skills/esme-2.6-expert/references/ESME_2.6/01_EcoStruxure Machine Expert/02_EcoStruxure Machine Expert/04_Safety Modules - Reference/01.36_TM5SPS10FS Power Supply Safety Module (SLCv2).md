# TM5SPS10FS Power Supply Safety Module (SLCv2)
...
Power supply safety-related module for internal I/O supply

24 VDC, 10 A

Output protection: Active switch-off for over-current and integrated protection for switching inductive loads.
...
## Group: SafeDigitalOutputxx and SafeDigitalOutputxxyy
...
| Relevant module parameters | In the parameter groups with the same channel number xx:   * AutoRestart  The related parameter descriptions can be found above in this topic. |
