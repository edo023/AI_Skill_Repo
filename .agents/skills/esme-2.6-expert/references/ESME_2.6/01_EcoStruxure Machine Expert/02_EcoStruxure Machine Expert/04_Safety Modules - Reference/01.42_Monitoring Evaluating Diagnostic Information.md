...
* set the machine into the application-specific defined safe-state depending on the results of the evaluation. The defined safe-state of the machine results from the risk analysis you must carry out for your safety-related application.
