...
With this parameter, you can read the diagnostic number of the device.

The parameter DiagnosticNumber corresponds to the Sercos parameter S-0-0390.
...
If diagnostic messages "C1D error" or "C2D warning" are triggered, this parameter can give a more precise explanation of what caused the detected error.

## Example

Example: DiagCodes in the Sercos IDN 390 'Diagnosis Number' for TM5CSLCx00FS
