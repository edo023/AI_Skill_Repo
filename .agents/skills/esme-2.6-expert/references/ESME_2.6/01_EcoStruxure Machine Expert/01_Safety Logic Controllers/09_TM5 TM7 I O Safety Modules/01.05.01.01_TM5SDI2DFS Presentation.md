# TM5SDI2DFS Presentation

## Main Features

The following table describes the main features of the Safety Digital Input module TM5SDI2DFS:

| Main Features | |
| --- | --- |
| Number of Inputs | 2 safety-related digital inputs |
| Input Type | configurable input filters, software input filter can be set by channel |
| Output Type | 2 test (pulse) outputs |
| Signal Type | sink |
...
| --- | --- | --- | --- |
| 2 | TM5SDI2DFS | TM5 Safety Digital Input module | red |
...
This figure presents the TM5SDI2DFS status LED indicators:

![](images/T002913553.gif)
