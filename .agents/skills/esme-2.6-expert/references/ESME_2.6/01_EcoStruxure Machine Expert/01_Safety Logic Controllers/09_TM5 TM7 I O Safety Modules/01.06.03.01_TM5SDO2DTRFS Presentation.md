# TM5SDO2DTRFS Presentation

## Main Features

The following table describes the main features of the Safety Relay Output module TM5SDO2DTRFS:

| Main Features | |
| --- | --- |
| Number of outputs | 2 relays |
| Output type | safety-related relay outputs, normally open contacts |
| Rated voltage | 230 Vac/6 A, 24 Vdc/6 A |
...
| --- | --- | --- | --- |
| 2 | TM5SDO2DTRFS | TM5 Safety Relay Output module | red |
...
This figure presents the TM5SDO2DTRFS status LED indicators:

![](images/T002913679.gif)
...
| LED indicator | Color | Status | Description |
| --- | --- | --- | --- |
| **1**  **2** | red | on | Indicates either that an error has been detected for the corresponding output or that the safety-related output is being used as a non-safety-related output.  NOTE: When there is no connection to the Safety Logic Controller, all channels are steady red. |
