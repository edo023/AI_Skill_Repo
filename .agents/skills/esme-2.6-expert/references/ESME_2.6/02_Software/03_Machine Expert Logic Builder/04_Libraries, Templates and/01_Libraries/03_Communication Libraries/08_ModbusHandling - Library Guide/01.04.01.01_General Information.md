...
The ModbusHandling library provides function blocks to implement Modbus client and server functionality in the application.
...
| --- | --- |
| Library title | ModbusHandling |
| Company | Schneider Electric |
| Category | Communication |
| Component | Core Libraries |
| Default namespace | MBSH |
...
NOTE: For this library, qualified-access-only is set. This means, that the POUs, data structures, enumerations, and constants have to be accessed using the namespace of the library. The default namespace of the library is MBSH.
