...
![](images/T001051348.gif)

## Functional Description

The function block UA\_NodeGetHandleList is used to get multiple node handles.
...
| NodeIDCount | UINT | Number of node Ids in NodeIDs array. |
| NodeIDs | ARRAY [1..GPL.MAX\_ELEMENTS\_NODELIST] OF UANodeID | Array containing node Ids.  Value range: 1.. GPL.MAX\_ELEMENTS\_NODELIST] |
...
| NodeHdls | ARRAY [1..GPL.MAX\_ELEMENTS\_ NODELIST] OF DWORD | Provides retrieved node handles. |
