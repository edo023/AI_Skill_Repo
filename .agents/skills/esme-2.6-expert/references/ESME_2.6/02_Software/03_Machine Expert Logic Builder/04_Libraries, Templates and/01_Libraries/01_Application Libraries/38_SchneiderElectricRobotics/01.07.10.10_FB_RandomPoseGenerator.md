...
| i\_astOrientationList | ARRAY [1...Gc\_udiMaxNumberOfOrientations] OF SE\_MATH.ST\_Vector3D | List of orientations expressed as roll, pitch, and yaw angles. The resulting Cartesian pose has an orientation randomly picked from this list accordingly with the values listed in i\_alrOrientationProbabilityList. |
