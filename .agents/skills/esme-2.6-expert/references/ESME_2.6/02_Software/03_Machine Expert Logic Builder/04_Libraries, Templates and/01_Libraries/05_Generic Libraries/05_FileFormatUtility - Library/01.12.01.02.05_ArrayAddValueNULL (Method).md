...
![](images/0000596115.png)

## Functional Description

This method is used for adding a NULL value in the sub hierarchy level as the selected element. The NULL value is added as the first in the array of elements.
...
| --- | --- |
| ``` { "SelectedArray" : ["ExistingValue"] } ``` | ``` { "SelectedArray" : [NULL, "ExistingValue"] } ``` |
