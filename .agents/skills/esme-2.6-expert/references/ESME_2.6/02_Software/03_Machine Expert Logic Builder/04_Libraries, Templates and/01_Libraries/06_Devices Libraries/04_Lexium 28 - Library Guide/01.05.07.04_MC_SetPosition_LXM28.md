...
| Position | DINT | Value range: -2147483648 ... 2147483647  Default value: 0  Value for position setting in the unit user-defined position. |
| Relative | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.  oFALSE: The actual position is set to the value of the input Position.  oTRUE: The value of the input Position is added to the actual position. |
