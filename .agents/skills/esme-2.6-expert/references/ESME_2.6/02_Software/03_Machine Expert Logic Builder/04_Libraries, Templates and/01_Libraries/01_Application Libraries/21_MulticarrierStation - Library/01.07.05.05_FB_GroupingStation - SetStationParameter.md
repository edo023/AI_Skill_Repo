# FB\_GroupingStation - SetStationParameter (Method)
...
![](images/0000758620.png)

## Task

Setting the parameters of the grouping station and specifying the target station to which the group(s) of carriers will be handed over.

## Description

With the method SetStationParameter, you can specify the following parameters:

* the target station to which the group of carriers will be transferred
* the process position to which the first carrier of the first group will move
...
NOTE: Before executing the method [CyclicMotionCall](CycMotionCall-EC493E53.html#CycMotionCall-EC493E53), the method SetStationParameter must be called at least once.
