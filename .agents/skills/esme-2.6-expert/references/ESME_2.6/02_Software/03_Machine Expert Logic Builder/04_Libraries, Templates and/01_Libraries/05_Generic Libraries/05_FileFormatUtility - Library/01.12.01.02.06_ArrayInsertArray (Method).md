...
![](images/0000596114.png)

## Functional Description

This method is used for inserting a new array in the hierarchy level as the selected element. The array is inserted as the next element from the selected element.
