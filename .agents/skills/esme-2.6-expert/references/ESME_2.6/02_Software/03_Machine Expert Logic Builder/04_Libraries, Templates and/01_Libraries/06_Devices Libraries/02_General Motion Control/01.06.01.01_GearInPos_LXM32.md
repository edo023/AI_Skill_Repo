...
Refer to the [documentation of the drive](D-SE-0093748.3.html#D-SE-0093748.3__D-SE-0093748.10) for additional information on compensation movements and error classes.
...
| SyncMode | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.  Compensation movement:   * FALSE: With compensation movement * TRUE: Without compensation movement |
...
| InGear | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: If the adjusted gear ratio is reached for the first time in the operating mode Electronic Gear. |
...
The operating mode Electronic Gear with the method velocity synchronization is started with the function block [GearIn\_LXM32](D-SE-0057305.html#D-SE-0057305).
