...
For example, if the tracking direction is ROB.ET\_RobotComponent.CartesianX and the configured working plane is SE\_MATH.ET\_CartesianPlane.XY, the Y axis is the one aligned to the width of the conveyor.
