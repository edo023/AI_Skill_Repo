...
| LimitSwitch | UINT | Value range: 1...2  Default value: 1  Selects the address of limit switch.   * 1: Limit switch in positive direction of movement **LIMP** * 2: Limit switch in negative direction of movement **LIMN** |
| Mode | UINT | Value range: 0...2  Default value: 0   * 0: Deactivate limit switch * 1: Activate limit switch as normally closed contact * 2: Activate limit switch as normally open contact |
...
The function block can only be executed in the PLCopen state Disabled (operating state 4 Ready To Switch On of drive). To transition to this state, disable the power stage with the function block MC\_Power.
