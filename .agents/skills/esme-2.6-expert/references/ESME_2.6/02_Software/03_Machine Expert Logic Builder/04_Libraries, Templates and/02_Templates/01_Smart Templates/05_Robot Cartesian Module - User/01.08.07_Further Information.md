...
* PacDrive 3 Template
  ...
  The generated code for SmartTemplate looks like this, but only the Logic is writeable/visible because it needs user adaptations. The other methods/actions are adapted automatically based on the graphical selection.
