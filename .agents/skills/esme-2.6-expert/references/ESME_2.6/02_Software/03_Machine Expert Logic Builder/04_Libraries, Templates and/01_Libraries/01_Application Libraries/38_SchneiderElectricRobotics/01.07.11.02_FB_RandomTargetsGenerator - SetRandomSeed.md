...
If the seed is left or set to zero, at the next call of a target generation method the seed is automatically initialized based on the current status of the CPU timer.
