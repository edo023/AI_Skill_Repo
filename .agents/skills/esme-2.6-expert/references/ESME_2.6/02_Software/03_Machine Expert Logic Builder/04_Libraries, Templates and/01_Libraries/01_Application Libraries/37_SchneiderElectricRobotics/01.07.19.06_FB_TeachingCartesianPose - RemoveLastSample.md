# FB\_TeachingCartesianPose - RemoveLastSample (Method)
...
* [Task](#FB_TeachingCartesianPose-RemoveLast-E35A73CE__Task-E35A82FC)
* [Description](#FB_TeachingCartesianPose-RemoveLast-E35A73CE__Description-E35A84A2)
* [Interface](#FB_TeachingCartesianPose-RemoveLast-E35A73CE__Interface-E35A8628)
* [Diagnostic Messages](#FB_TeachingCartesianPose-RemoveLast-E35A73CE__DiagnosticMessages-E35A877C)
...
| --- | --- | --- | --- |
| FALSE | Ok | 0 | Success. |
| FALSE | PreviousSetSelected | 33 | The previous set is selected as active. |
...
|  |  |
| --- | --- |
| Enumeration name: | NoSamplesToRemove |
| Enumeration value: | 34 |
| Description: | No samples available to remove. |

| Issue | Cause | Solution |
| --- | --- | --- |
| Not possible to remove the last sample. | There are no samples stored in the function block. | Do not call this method if there are no available samples to remove. |
...
| Description: | The previous set is selected as active. |
