...
* PacDrive 3 Template
  ...
  The generated code for SmartTemplate looks like this, but only the Logic and Calibration is writeable/visible because it needs user adaptations. The other methods/actions are adapted automatically based on the graphical selection.
  ...
  + Adaptations of RobotModule+ compared to the FB\_RobotModule of the library RoboticModule:
    ...
    - The FB\_RobotModule cannot be used (per default) stand-alone with (or without) the PacDrive 3 Template.
