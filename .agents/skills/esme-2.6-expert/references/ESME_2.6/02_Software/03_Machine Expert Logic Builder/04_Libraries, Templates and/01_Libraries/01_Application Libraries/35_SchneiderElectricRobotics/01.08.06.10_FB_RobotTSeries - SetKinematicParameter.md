# FB\_RobotTSeries - SetKinematicParameter (Method)
...
* [Task](#D-SE-0075206__D-SE-0075206.3)
* [Description](#D-SE-0075206__D-SE-0075206.12)
* [Use of](#D-SE-0075206__D-SE-0075206.4) i\_stCenterOfMass
* [Interface](#D-SE-0075206__D-SE-0075206.5)
* [Diagnostic Messages](#D-SE-0075206__D-SE-0075206.6)
...
With i\_stCenterOfMass, you can define the vector that describes the location of the center of mass of the selected kinematic parameter. The picture shows a Lexium T Robot with a default coordinate system.
...
![](images/T002803677.gif)

In this example, the payload is mounted in the XZ-plane.

![](images/T002803676.gif)

With the dimension shown in the next picture, the i\_stCenterOfMass has to have the following values.

* i\_stCenterOfMass.lrX := 49.592;
* i\_stCenterOfMass.lrY := 0.0;
