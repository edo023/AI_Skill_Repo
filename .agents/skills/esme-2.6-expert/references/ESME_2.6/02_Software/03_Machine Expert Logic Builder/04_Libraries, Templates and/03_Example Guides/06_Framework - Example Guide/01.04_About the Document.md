...
The Framework Example Guide describes the functionalities of the Framework project that provides a core program structure with predefined units tailored for various use cases.

The following knowledge is required:

* Programming in the ST language
* How to connect and log in to a Modicon M660 Motion Controller and / or a Modicon  M262 Motion Controller
* MotionFunctionBlocks library
* PackML library
* Functionality of the Schneider Electric framework for the Modicon  M262 Motion Controller or Modicon M660 Motion Controller

  NOTE: Modicon M660 Motion Controllers are exclusive to EcoStruxure Machine Expert V2.5 and greater versions.
