...
![](images/T003225433.gif)

## Functional Description

Adds the literal name token `null` to an open ARRAY in the STRING that is being processed.
...
Calling the method ArrayAddNull adds the text marked in bold in the example to the STRING:
