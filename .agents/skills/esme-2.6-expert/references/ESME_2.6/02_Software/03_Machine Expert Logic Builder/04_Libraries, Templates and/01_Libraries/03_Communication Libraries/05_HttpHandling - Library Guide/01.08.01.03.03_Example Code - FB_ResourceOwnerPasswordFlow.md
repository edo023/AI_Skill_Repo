# Example Code - FB\_ResourceOwnerPasswordFlow

## Overview

The following example shows how to authenticate using the resource owner password flow defined in the OAuth protocol and to send an HTTP Get request to access the protected resource:
...
VAR
    ...
    sResultMsg : STRING;	
    //OAuth
    fbOAuthFlow : SE_Http.FB_ResourceOwnerPasswordFlow;
...
CASE fbHTTP.State OF
    ...
    SE_HTTP.ET_State.Connected:
        ...
        fbOAuthFlow.Username := 'username';
        fbOAuthFlow.Password := 'password';
