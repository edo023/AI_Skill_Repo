...
This function block writes the value for the quick stop deceleration of the drive. This value is used if the function block MC\_Stop is executed.
...
| Deceleration | DINT | Value range: 200...3000000  Default value: 6000  Value for the deceleration ramp in rpm/s. |
