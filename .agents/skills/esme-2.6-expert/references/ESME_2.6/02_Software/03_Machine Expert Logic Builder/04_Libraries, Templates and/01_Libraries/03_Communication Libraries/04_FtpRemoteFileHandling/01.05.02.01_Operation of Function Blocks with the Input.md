# Operation of Function Blocks with the Input i\_xEnable and i\_xExecute
...
If q\_xError indicates TRUE, an error has been detected during execution. A renewed execution of the function block is not possible as long the error state is present. The function block must be disabled in order to reset the error state.
