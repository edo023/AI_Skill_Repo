# FB\_WriteDeviceParameter - Functional Description
...
The function block FB\_WriteDeviceParameter is used to write parameters to the IO-Link device.

![](images/0000791426.png)
...
| i\_stParameterAddress | [ST\_ParameterAddress](ST_EventParameters-0C90CD2A.html#ST_EventParameters-0C90CD2A) | – | Structure containing the parameter address. |
