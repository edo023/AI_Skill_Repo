...
MC\_MoveRelative\_LXM28

Functional Description

The function block starts a movement by distance Distance with reference to the actual position and at velocity Velocity.
...
| Distance | DINT | Value range: -2147483648 ... 2147483647  Default value: 0  Target position relative with reference to actual position in the unit user-defined position. |
