...
| Issue | Cause | Solution |
| --- | --- | --- |
| The list of slots has not been successfully configured. | One of the orientation convention values for the poses of i\_astSlotPosesList is invalid. | Provide one of the permissible values of ROB.ET\_OrientationConvention.  Refer to [*Robotic Library - ET\_OrientationConvention*](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.Robotic&topicID=D_SE_0075485). |
