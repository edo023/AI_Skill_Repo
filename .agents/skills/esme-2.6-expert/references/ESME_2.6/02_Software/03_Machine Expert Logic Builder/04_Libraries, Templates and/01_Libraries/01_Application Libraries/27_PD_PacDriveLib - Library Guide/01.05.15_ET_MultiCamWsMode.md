...
Enumeration type for the warm start mode of the [FB\_MultiCam](../Function_Blocks_I_to_Q/Function_Blocks_I_to_Q-14.htm#XREF_D_SE_0087313_1) slave.
...
The YPeriod can also be specified directly in the MultiCam structure ([ST\_MultiCam](../Structures/Structures-32.htm#XREF_D_SE_0087770_1)). As soon as MultiCamStruct.YPeriod <> 0, the value from the structure is used.

The input structure [ST\_MultiCamExt](../Structures/Structures-33.htm#XREF_D_SE_0087772_1) contains two parameters which influence the behavior of the warm start.
