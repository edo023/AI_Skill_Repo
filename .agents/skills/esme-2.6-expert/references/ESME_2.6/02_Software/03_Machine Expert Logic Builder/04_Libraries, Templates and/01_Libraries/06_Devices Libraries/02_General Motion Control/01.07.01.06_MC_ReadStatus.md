...
| Errorstop | DINT | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: Drive in operating state Errorstop. |
| Disabled | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: Power stage is disabled. |
| Stopping | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: Drive in operating state Stopping. |
| Homing | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: Drive in operating state Homing. |
| StandStill | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: Drive in operating state StandStill. |
| DiscreteMotion | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: Drive in operating state Discrete Motion. |
| ContinuousMotion | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: Drive in operating state Continuous Motion. |
| SynchronizedMotion | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * TRUE: Drive in operating state Synchronized Motion. |
