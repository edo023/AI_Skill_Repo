...
The task configuration of the application example contains beside the default task MAST one additional task Translator.

The graphic provides an overview about the different tasks and the associated program calls.

![G-SE-0059379.1.gif-high.gif](images/G-SE-0059379.1.gif-high.gif)
