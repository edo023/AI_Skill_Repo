...
![G-SE-0058874.1.gif-high.gif](images/G-SE-0058874.1.gif-high.gif)

In addition, for each Altivar module a separate visualization screen is implemented. These visualization screens provide extensive control functions which can be used during commissioning phase.
