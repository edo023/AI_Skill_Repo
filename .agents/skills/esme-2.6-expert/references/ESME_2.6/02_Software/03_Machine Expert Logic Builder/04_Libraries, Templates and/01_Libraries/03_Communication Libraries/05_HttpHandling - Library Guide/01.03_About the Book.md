...
This document describes the library HttpHandling.
...
| ProxyCommunicationSupport Library Guide | [EIO0000004579 (ENG)](https://www.se.com/ww/en/download/document/EIO0000004579/) |
...
| WARNING | |
| --- | --- |
|  | UNINTENDED EQUIPMENT OPERATION  Do not put any application program file (receipt file, G-Code file, firmware file, etc.) that you received as an email attachment into service unless it is from a known, trusted source and that you have thoroughly tested it for proper operation.  Failure to follow these instructions can result in death, serious injury, or equipment damage. |
