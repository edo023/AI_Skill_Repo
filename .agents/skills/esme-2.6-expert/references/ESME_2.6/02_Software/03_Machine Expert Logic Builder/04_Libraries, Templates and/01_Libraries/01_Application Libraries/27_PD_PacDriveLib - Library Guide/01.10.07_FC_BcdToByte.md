...
The function converts values in the decimal range 0..99 from BCD format into binary format.

Interface

| Input | Data type | Description |
| --- | --- | --- |
| i\_byInput | BYTE | Two-digit number in BCD format |
...
| --- | --- |
| BYTE | Value of the input i\_byInput in binary coding |

Diagnostic Messages

| q\_etDiag | q\_etDiagExt | Enumeration value | Description |
| --- | --- | --- | --- |
| OK | [Ok](#XREF_D_SE_0087397_8) | 0 | Ok |
