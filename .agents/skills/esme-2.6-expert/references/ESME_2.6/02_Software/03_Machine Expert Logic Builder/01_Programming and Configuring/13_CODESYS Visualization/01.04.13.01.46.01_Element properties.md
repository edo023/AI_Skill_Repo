...
|  |  |
| --- | --- |
| **Element name** | Example: `TimeRangeTemperature`  TIP: Assign individual names for elements so that they are found faster in the element list. |
| **Element Type** | **Time range picker** |
