...
In some cases, scripts have to interact with the user. Simple APIs are provided for common interactions. The sample script *System\_UI\_Test.py* shows the possible functions.
