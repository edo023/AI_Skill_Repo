...
|  |  |
| --- | --- |
| **Element name** | Example: `Workpiece_3`  TIP: Assign individual names for elements so that they are found faster in the element list. |
| **Element Type** | **Rectangle**, **Rounded Rectangle**, or **Ellipse** |
