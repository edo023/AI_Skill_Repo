...
This document describes the menu commands and commands in text editors available in the Logic Builder, the configuration and programming environment for the EcoStruxure Machine Expert projects. Not all commands described here are by default available in a menu. If a command is not available, you can insert it in a menu of your choice by using the Tools > Customize [dialog box](D-SE-0084066.html#D-SE-0084066).
...
* English (EIO0000002860)
* French (EIO0000002861)
* German (EIO0000002862)
* Italian (EIO0000002863)
* Spanish (EIO0000002864)
* Chinese (EIO0000002865)
...
| How To Manage Certificates on the Controller User Guide | [EIO0000003897 (ENG)](https://www.se.com/en/download/document/EIO0000003897);  [EIO0000003898 (FRE)](https://www.se.com/en/download/document/EIO0000003898);  [EIO0000003899 (GER)](https://www.se.com/en/download/document/EIO0000003899);  [EIO0000003901 (SPA)](https://www.se.com/en/download/document/EIO0000003901);  [EIO0000003900 (ITA)](https://www.se.com/en/download/document/EIO0000003900);  [EIO0000003902 (CHS)](https://www.se.com/en/download/document/EIO0000003902) |
