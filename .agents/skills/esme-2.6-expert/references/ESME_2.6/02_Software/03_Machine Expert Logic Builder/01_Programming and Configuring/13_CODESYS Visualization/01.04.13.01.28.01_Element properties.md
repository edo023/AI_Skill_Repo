...
| **Variable** | Variable (numeric data type) for the position of the needle of the potentiometer  The visualization user can modify the value by dragging the pointer to another position. |
