...
|  |  |
| --- | --- |
| **Element name** | Example: `Werkstueck_1`  TIP: Assign individual names for elements so that they are found faster in the element list. |
| **Element Type** | * **Polygon** * **Polyline** * **Bézier Curve** |
