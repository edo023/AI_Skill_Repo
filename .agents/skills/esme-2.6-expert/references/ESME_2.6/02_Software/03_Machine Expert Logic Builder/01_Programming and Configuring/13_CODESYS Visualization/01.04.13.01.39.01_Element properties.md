...
|  |  |
| --- | --- |
| **Element name** | Example: `Data_Transfer`  TIP: Assign individual names for elements so that they are found faster in the element list. |
| **Element Type** | **Busy Symbol, Cube** |
