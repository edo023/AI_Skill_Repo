# EtherNet/IP – Bus Cycle Task

**General Information**

The global settings for all tasks can be found below the task object on the Task Configuration tab.
...
|  |  |
| --- | --- |
| (1) Read inputs from input buffer | (6) Output buffer |
| (2) IEC task | (7) Copy data to/from bus |
| (3) Writing outputs to output buffer | (9) Bus cycle task, priority 1, 1 ms |
| (4) Bus cycle | (10) Bus cycle task, priority 5 |
| (5) Input buffer | (11) Bus cycle task, priority 10, interrupted by task 5 |
