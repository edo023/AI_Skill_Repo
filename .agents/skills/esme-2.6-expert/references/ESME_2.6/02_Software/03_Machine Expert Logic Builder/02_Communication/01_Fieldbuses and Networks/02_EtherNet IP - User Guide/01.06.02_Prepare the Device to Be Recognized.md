...
The aim of this step is to configure the IP address assignment method of the device to be in accordance with that configured for the  [network planning](D-SE-0056549.html#D-SE-0056549__D-SE-0056549.4).
...
If using EtherNet/IP, and using [Electronic Keying](#D-SE-0056612__D-SE-0056612.8), verify whether it is correctly configured.
...
| PC, tablet, … | DHCP  BOOTP  Fixed IP | Use PC or tablet to connect to the **Device Web server** and configure the network settings.  Choose a connection method:   * Connect the PC to an Ethernet port of the device.  The current IP address of the device must be known. * Connect a WIFER TCSEGWB13FA0 to an Ethernet port of the device.  Connect the PC to the WIFER. |
...
* [Set the MAC address of the new device](D-SE-0056549.html#D-SE-0056549__D-SE-0056549.4),
...
* verify, and modify if necessary, the values of the [Electronic Keying](D-SE-0056939.html#D-SE-0056939),
* load the new application in the controller.
