# Set\_Attribute\_Single: Set an Attribute of an Object
...
| i\_dwAttribute | DWORD | Target attribute.  Refer to [How To Find Object Information in Device Documentation](D-SE-0061206.html#D-SE-0061206).  It must be  0xFFFFFFFF if the attribute is not part of the request. |
...
| **(1)** The input data buffer must be formatted as well. Refer to Set\_Attribute\_Single request data in the ODVA EtherNet/IP specification volume 1. | | |
