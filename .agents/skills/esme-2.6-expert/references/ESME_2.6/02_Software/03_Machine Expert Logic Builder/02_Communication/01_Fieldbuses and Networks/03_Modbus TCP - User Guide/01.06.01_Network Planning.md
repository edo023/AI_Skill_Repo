...
To design and plan the Industrial Ethernet network, refer to the corresponding documentation, such as the *Media Planning and Installation Manual*, by ODVA. You can download this manual from the [ODVA website](http://www.odva.org/Home/ODVATECHNOLOGIES/EtherNetIP/EtherNetIPLibrary.aspx).
