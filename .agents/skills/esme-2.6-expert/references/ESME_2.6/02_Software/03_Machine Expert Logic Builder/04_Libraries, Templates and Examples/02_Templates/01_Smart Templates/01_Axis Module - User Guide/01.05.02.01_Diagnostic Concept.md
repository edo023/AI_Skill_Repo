...
An exception exists if the q\_etDiag is <> GD.ET\_Diag.Ok. The functions are processed completely in the call-up task, then their status can be evaluated and they report via q\_etDiag and q\_etDiagExt whether their processing was successful.
