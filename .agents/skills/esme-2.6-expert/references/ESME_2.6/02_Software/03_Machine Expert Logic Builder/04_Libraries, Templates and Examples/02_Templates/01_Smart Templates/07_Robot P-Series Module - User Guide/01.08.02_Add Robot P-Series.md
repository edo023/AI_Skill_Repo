...
![](images/T001805072.png)

| Step | Action |
| --- | --- |
| 1 | Select a Name for the robot (1). The created object and the created drives use this name. |
| 2 | Use the Filters to reduce the list of robot types (2):   * Manually input: Start typing the reference number (for example, VRKP4S) * Robot size: P2, P4, P6 * Motor type: SH or ILM * Rotational axis: With or without rotational axis |
