...
The library ProxyCommunicationSupport provides functionality to support the communication with a remote server through a proxy server.
...
| --- | --- |
| Library title | ProxyCommunicationSupport |
| Company | Schneider Electric |
| Category | Communication |
| Component | Core Libraries |
| Default namespace | PXCS |
...
NOTE: For this library, qualified-access-only is set. The POUs, data structures, enumerations, and constants must be accessed using the namespace of the library. The default namespace of the library is PXCS.
