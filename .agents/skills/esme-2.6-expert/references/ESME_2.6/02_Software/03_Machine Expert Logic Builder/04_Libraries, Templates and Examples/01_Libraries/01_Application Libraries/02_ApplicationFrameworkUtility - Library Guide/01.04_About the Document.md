...
This document describes the ApplicationFrameworkUtility library.

The library provides functions for the framework for the Modicon M660 motion controller.
