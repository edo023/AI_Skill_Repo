...
The library provides SQL (Structured Query Language) client function blocks that allow your controller to connect to an SQL database in order to run SQL queries for reading and writing data.

As a prerequisite for using SQL functions, you have to install the SQL Gateway that is supplied with EcoStruxure Machine Expert as an optional component and that requires a specific license.
...
| SQL Gateway User Guide | [EIO0000002417 (ENG)](https://www.se.com/ww/en/download/document/EIO0000002417);  [EIO0000002418 (FRE)](https://www.se.com/ww/en/download/document/EIO0000002418);  [EIO0000002419 (GER)](https://www.se.com/ww/en/download/document/EIO0000002419);  [EIO0000002421 (SPA)](https://www.se.com/ww/en/download/document/EIO0000002421);  [EIO0000002420 (ITA)](https://www.se.com/ww/en/download/document/EIO0000002420);  [EIO0000002422 (CHS)](https://www.se.com/ww/en/download/document/EIO0000002422) |
