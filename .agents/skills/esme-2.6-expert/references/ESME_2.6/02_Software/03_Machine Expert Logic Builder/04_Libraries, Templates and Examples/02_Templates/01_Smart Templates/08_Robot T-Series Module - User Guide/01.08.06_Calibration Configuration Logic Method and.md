...
NOTE: You can use the function block *[SER.FB\_CalibrationTSeries](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.SchneiderElectricRobotics&topicID=0000675097)* to execute the calibration.

The method Calibration has an input (i\_ifCalibration: *[SER.IF\_RobotTSeriesCalibration](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.SchneiderElectricRobotics&topicID=D_SE_0075229)*) and an output (q\_xRequest).
