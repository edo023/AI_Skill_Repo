...
This library contains a set of functions to perform collision and distance queries between two or more 3D objects.

## Validity Note

This document has been updated for EcoStruxureTM Machine Expert V2.0.
...
| GeoMath, Library Guide | EIO0000004466 (ENG) |
