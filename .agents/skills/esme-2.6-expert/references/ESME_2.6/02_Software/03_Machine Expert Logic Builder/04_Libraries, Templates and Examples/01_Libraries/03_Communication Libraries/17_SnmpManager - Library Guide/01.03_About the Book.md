...
This document describes the SnmpManager library.
...
The SnmpManager library uses system functions and resources which are supported on specific controller platforms with Ethernet ports available in EcoStruxure Machine Expert.
