# FC\_SetEnableLoadEff - General Information
...
| --- | --- | --- |
| i\_xEnableLoadEff | BOOL | Specifies the value for LMC\_PacDrive.EnableLoadEff. |
...
| --- | --- | --- |
| - | This function is not supported on the controller. | Use a other controller. |
