# FB\_EntitiesHandler - CalcEntitiesRelativePose (Method)
...
* [Task](#D-SE-0098145__D-SE-0098145.55)
* [Description](#D-SE-0098145__D-SE-0098145.3)
* [Interface](#D-SE-0098145__D-SE-0098145.4)
* [Return Value](#D-SE-0098145__D-SE-0098145.50)
* [Diagnostic Messages](#D-SE-0098145__D-SE-0098145.5)
...
| i\_etOrientationConvention | SE\_MATH.ET\_OrientationConvention | Orientation convention used to represent the orientation of the resulting pose.  Admissible values are in the ranges:   * SE\_MATH.ET\_OrientationConvention.XYZ * SE\_MATH.ET\_OrientationConvention.ZYX |
...
| Issue | Cause | Solution |
| --- | --- | --- |
| The relative pose has not been successfully evaluated. | i\_etOrientationConvention contains an invalid orientation convention. | Provide a valid value for the orientation convention.  Admissible values are:   * SE\_MATH.ET\_OrientationConvention * SE\_MATH.ET\_OrientationConvention |
...
| Description: | A provided target generator type is indeterminable. |

| Issue | Cause | Solution |
| --- | --- | --- |
| A provided target generator ID is indeterminable. | i\_etTargetGeneratorId contains an indeterminable target generator system ID. | Ensure that the value of i\_etTargetGeneratorId refers to a previously configured target generator. |
