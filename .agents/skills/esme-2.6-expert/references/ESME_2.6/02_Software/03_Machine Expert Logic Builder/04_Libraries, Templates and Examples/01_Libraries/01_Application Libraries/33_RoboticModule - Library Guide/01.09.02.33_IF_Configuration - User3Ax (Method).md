# IF\_Configuration - User3Ax (Method)
...
* [Task](#D-SE-0076931__D-SE-0076931.3)
* [Description](#D-SE-0076931__D-SE-0076931.4)
* [Interface](#D-SE-0076931__D-SE-0076931.5)
* [Diagnostic Messages](#D-SE-0076931__D-SE-0076931.6)
...
The calculation of the direct and inverse transformation must be realized in a user POU that implements the *[ROB.IF\_UserTransformation3Ax](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.Robotic&topicID=D_SE_0075603)* interface.
...
| i\_ifTransformation | [ROB.IF\_UserTransformation3Ax](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.Robotic&topicID=D_SE_0075603) | Interface with the implementation to calculate the direct and inverse transformation. |
...
| Issue | Cause | Solution |
| --- | --- | --- |
| The configuration of the robot transformation was not successful. | A drive was transferred at the input i\_ifDriveB or i\_ifDriveC. | Ensure that at the input i\_ifDriveA a valid drive has been transferred. |
...
| Issue | Cause | Solution |
| --- | --- | --- |
| The configuration of the robot transformation was not successful. | A drive was transferred at the i\_ifDriveC input. | Ensure that at the input i\_ifDriveB a valid drive has been transferred. |
...
| Issue | Cause | Solution |
| --- | --- | --- |
| The configuration of the robot transformation was not successful. | The configuring of the robot transformation has already been completed successfully. | Ensure that a configuration for a transformation is only called once. |
...
| Issue | Cause | Solution |
| --- | --- | --- |
| The configuration of the robot transformation was not successful. | The interface transferred at the i\_ifTransformation input is invalid. | Ensure that at the input i\_ifTransformation a valid interface has been transferred. |
