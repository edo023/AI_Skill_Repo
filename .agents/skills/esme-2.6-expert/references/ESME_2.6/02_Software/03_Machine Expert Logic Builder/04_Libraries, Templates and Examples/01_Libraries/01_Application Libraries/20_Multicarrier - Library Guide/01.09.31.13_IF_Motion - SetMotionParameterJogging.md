# IF\_Motion - SetMotionParameterJogging (Method)
...
![](images/0000757692.png)

## Task

Setting the motion parameters for jogging.
...
NOTE: The values defined with the method SetMotionParameterJogging must be smaller than the corresponding values defined with the method [SetEmergencyParameter](IF_MulticarrierConfiguration-SetEme-7E9E3DC9.html#IF_MulticarrierConfiguration-SetEme-7E9E3DC9).
