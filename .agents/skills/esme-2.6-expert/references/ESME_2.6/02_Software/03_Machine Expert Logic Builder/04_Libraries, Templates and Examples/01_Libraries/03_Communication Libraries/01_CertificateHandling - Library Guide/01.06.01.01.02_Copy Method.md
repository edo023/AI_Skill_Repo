...
![](images/0000807855.png)

## Functional Description

This method is used to store a copy of the selected certificate with the specified trust level.
...
The return value of this function indicates whether the certificate could be copied.

## Interface

| Input | Data type | Description |
| --- | --- | --- |
| i\_etDestinationTrustLevel | ET\_TrustLevel | The trust level to which the certificate is copied. |
...
| --- | --- | --- |
| Copy | BOOL | If this output is set to TRUE, the selected certificate has been successfully copied to the selected trust level. |
