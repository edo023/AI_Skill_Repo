...
![](images/DD00730496.png)

## Structure Elements

| Name | Data type | Description |
| --- | --- | --- |
| ifVelocitySource | SystemConfigurationItf.IF\_IdentificationMandatory | Velocity source related to the linear motion system that must be considered during the teaching procedure. |
| stLEncLogicalAddress | SystemConfiguration.ST\_LogicalAddress | Logical encoder which is used to update the position of the reference points. |
