...
This document describes the DigitalTwinCommunication library.

The library provides OPC UA structures to build and emulate Schneider Electric devices in EcoStruxure Machine Expert Twin.

The settings defined in this library allow you to automatically generate a 3D digital twin of your machine in EcoStruxure Machine Expert Twin using the SmartVisu feature. The SmartVisu feature uses predefined catalogs and ready-to-use mechatronic components and is included in the Builder License.

For further information on EcoStruxure Machine Expert Twin, refer to the [EcoStruxure Machine Expert Twin online help](https://product-help.se.com/Machine%20Expert%20Twin/latest).
