...
```
fbLoggerPointMainMachine.RegisterLoggerPoint(
	i_ifParent := APL.G_ifApplicationLogger, 
...
```
fbLoggerPointAlpha.RegisterLoggerPoint(
	i_ifParent := fbLoggerPointMainMachine,
	i_sName := 'Machine name',
	i_sType := 'MainMachine',
	i_sSource := 'Project',
	q_etDiag => ,
