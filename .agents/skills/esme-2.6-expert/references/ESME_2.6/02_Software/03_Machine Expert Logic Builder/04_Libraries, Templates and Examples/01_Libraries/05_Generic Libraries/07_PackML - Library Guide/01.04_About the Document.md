...
The POUs provided with this library use variables of type POINTER TO internally. These pointers are assigned only on start of execution of the respective POU. This is, the pointers are not reassigned while the function block indicates `Busy`.

| CAUTION | |
| --- | --- |
|  | INVALID POINTER  Do not use the “Online Change” command or the “Log in with online change” option as long as one of the function blocks of this library indicates `Busy` in your running application.  Failure to follow these instructions can result in injury or equipment damage. |
...
* [English (EIO0000002809)](https://www.se.com/en/download/document/EIO0000002809)
