...
The Smart Template Robot Cartesian Module contains the functionality to parametrize a Schneider Electric Cartesian robot in a graphical way and use it in a PacDrive 3 Template or in other EcoStruxure Machine Expert software architectures.
...
| --- | --- |
| Robotic Library Guide | EIO0000002232 (ENG) |
| SchneiderElectricRobotics Library Guide | EIO0000002236 (ENG) |
