...
![](images/T000690971.gif)

## Task

The method Put initiates the HTTP method to replace the representations of the target resource with the request payload.
...
A call of the method Put is allowed only in state Connected.
...
NOTE: In case of online modifications while the function block is processing a Put request, the execution is aborted to prevent a possible access violation caused by processing erroneous pointer addresses.
