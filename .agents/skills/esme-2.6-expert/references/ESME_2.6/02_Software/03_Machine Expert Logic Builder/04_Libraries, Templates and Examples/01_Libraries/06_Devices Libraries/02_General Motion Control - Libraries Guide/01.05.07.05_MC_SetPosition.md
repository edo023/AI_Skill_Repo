...
| Position | DINT | Value range: -2147483648...2147483647  Default value: 0  Position in user-defined units.  Value for position setting. |
| Relative | BOOL | Value range: FALSE, TRUE.  Default value: FALSE.   * FALSE: The actual position is set to the value of the input Position. * TRUE: The value of the Position is added to the actual position. |
