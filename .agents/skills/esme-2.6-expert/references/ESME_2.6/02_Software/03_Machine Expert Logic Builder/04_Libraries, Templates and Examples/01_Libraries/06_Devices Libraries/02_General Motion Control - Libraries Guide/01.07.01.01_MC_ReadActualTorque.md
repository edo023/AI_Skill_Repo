...
| Torque | INT | Value range: -32768...32767  Actual torque in user-defined units.  100.0 % corresponds to the continuous stall torque. The read value is indicated in increments of 0.1 %.  Example: The value Torque = 300 is read. This means that the effective torque amounts to 30 % of the nominal torque of the motor. |
