# FC\_Matrix4DAddition - General Information
...
* [Description](#FC_Matrix-9F6F3D28__Description-9F6EDBDB)
* [Interface](#FC_Matrix-9F6F3D28__Interface-9F6EDDBF)
* [Return Value](#FC_Matrix-9F6F3D28__ReturnValue-9F6EDFF1)
* [Diagnostic Messages](#FC_Matrix-9F6F3D28__DiagnosticMessages-9F6EE12F)

## Description

Given two 4D input matrices, the function returns the element-wise addition of their elements.

![](images/0000610073.png)

## Interface

| Input | Data type | Description |
| --- | --- | --- |
| i\_stMatrixA | SE\_MATH.ST\_Matrix4D | First 4D matrix to add. |
| i\_stMatrixB | SE\_MATH.ST\_Matrix4D | Second 4D matrix to add. |
...
| --- | --- |
| SE\_MATH.ST\_Matrix4D | The function returns the element-wise addition of the elements of two 4D input matrices. |
