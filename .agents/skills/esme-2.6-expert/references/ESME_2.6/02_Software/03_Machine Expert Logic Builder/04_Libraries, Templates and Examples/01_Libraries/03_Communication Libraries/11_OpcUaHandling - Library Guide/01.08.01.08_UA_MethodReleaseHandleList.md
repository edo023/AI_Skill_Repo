...
![](images/0000978515.png)

## Functional Description

The function block UA\_MethodReleaseHandleList is used to release a set of the method handles.
...
| MethodHdlCount | UINT | Number of method handles in the array MethodHdls. It must not exceed the value of [GPL.MAX\_ELEMENTS\_METHOD](D-SE-0100002.html#D-SE-0100002__D-SE-0100002.7). |
| MethodHdls | ARRAY [1..GPL. MAX\_ELEMENTS\_METHOD] OF DWORD | Array containing method handles. |
...
| ErrorIDs | ARRAY [1..GPL. MAX\_ELEMENTS\_METHOD] OF ET\_Result | Array containing error codes for each method handle specified inside the array at the function block input. |
