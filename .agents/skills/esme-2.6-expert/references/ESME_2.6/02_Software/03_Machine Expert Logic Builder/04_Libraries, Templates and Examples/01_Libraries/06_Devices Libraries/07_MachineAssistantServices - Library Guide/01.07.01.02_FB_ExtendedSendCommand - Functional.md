# FB\_ExtendedSendCommand - Functional Description
...
![](images/T002930789.png)

## Functional Description

The function block FB\_ExtendedSendCommand is used to build a user-defined command, and to send the command to a detected device.
...
Also refer to [Best Practices](D-SE-0094978.html#D-SE-0094978).
...
| i\_sExtendedSendCommand | STRING[255] | String which contains the user-defined command to be executed. |
