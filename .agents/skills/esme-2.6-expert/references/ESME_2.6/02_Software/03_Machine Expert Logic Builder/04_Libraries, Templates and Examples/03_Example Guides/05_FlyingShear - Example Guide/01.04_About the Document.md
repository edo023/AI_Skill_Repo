...
The FlyingShear Example Guide describes the functionalities of the FlyingShear project that provides a solution to perform a process step typical for continuous manufacturing environments. In this example, a continuous product is fed through the system on a belt and the FlyingShear performs precise cutting operations on the fly, without stopping the belt.
...
* PackML library
* Functionality of the framework for the Modicon M262 Logic/Motion Controller or Modicon M660 Motion Controller

  NOTE: Modicon M660 Motion Controllers are exclusive to EcoStruxure Machine Expert V2.5 and greater.
...
| EcoStruxure Machine Expert, CommonToolbox Library Guide | [EIO0000004219 (ENG)](https://www.se.com/en/download/document/EIO0000004219) |
...
| EcoStruxure Machine Expert PackML Library Guide | [EIO0000002809 (ENG)](https://www.se.com/en/download/document/EIO0000002809) |
