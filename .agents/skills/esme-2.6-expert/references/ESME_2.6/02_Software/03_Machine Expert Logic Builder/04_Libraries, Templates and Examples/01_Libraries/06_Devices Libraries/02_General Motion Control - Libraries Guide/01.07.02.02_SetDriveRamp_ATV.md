...
| Acceleration | DINT | Value range: 0...9999  Default value: 30  Unit: 0.1 s.  **Example:**  With a value of 30, 3 seconds are required to accelerate from 0 to the nominal frequency of the motor. It must be possible to reach the value with the available torque of the motor. |
| Deceleration | DINT | Value range: 0...9999  Default value: 30  Unit: 0.1 s.  **Example:**  With a value of 30, 3 seconds are required to decelerate from the nominal frequency of the motor to 0. It must be possible to reach the value with the available torque of the motor. |
