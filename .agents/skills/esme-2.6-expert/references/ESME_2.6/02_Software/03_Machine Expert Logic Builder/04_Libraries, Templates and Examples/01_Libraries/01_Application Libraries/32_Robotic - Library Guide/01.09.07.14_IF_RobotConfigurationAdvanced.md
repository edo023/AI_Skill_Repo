# IF\_RobotConfigurationAdvanced - ModifyCoordinateSystem (Method)
...
* [Task](#D-SE-0075536__D-SE-0075536.3)
* [Description](#D-SE-0075536__D-SE-0075536.4)
* [Interface](#D-SE-0075536__D-SE-0075536.5)
* [Diagnostic Messages](#D-SE-0075536__D-SE-0075536.6)
...
| --- | --- | --- |
| i\_etName | [ET\_CoordinateSystem](D-SE-0075477.html#D-SE-0075477) | Name of the coordinate system that has to be modified. |
...
| --- | --- | --- |
| The modification of a coordinate system of the robot was not successful. | There are still active move commands. | Ensure that no more move commands are active. |
...
| Issue | Cause | Solution |
| --- | --- | --- |
| The modification of a coordinate system of the robot was not successful. | The value transferred at the input i\_etName is invalid. | At the input i\_etName, a value of ET\_CoordinateSystem must be transferred. |
...
| Issue | Cause | Solution |
| --- | --- | --- |
| The modification of a coordinate system of the robot was not successful. | The robot is still in tracking and not in coordinate system ET\_CoordinateSystem.CSR. | Do not call ModifyCoordinateSystem(...) while the robot is in tracking. |
