# IF\_TargetsHandlerEventsListener - OnSetTargetProcessed (Method)
...
* [Task](#D-SE-0098390__D-SE-0098390.3)
* [Description](#D-SE-0098390__D-SE-0098390.4)
* [Interface](#D-SE-0098390__D-SE-0098390.5)
* [Diagnostic Messages](#D-SE-0098390__D-SE-0098390.7)

## Task

Provides user-specific diagnostics when the processed state of a target is set.

## Description

The OnSetTargetProcessed method is called by the targets handler where the implementation of IF\_TargetsHandlerEventsListener has been subscribed every time the processed state of a target is set.
...
| --- | --- | --- |
| i\_stTarget | ST\_RobotTarget | Robot target structure containing the information on the target which processed state is going to be set. |
