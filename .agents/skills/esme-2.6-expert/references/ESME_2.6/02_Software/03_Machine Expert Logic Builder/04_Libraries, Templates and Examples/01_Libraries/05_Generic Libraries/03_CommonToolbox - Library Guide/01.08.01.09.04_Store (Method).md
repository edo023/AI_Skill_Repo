...
The method Store is used to add a value to the stack.
...
| --- | --- | --- |
| i\_anyValue | ANY | Variable to be stored inside the stack. |
...
| --- | --- | --- |
| q\_xError = TRUE  q\_etResult = SizeMismatch | The size of the variable assigned to the input i\_anyValue must be equal to the object size defined during the instantiation of the function block. | Assign a variable to i\_anyValue with a size which is equal to the object size defined during the instantiation of the function block. |
...
| q\_xError = TRUE  q\_etResult = RegisterFull | No element can be stored as stack is full. | Retrieve a value or reset the stack before storing a value. |
