...
![](images/0000596455.png)

## Functional Description

This method is used to add a new item in the sub-hierarchy level as the selected element. The object is added as the first element in the array of elements.
...
| --- | --- |
| ``` { "SelectedObject" : {"ExistingName" : "ExistingValue"} } ``` | ``` { "SelectedObject" : {"NewObject" : {}, "ExistingName" : "ExistingValue"} } ``` |
