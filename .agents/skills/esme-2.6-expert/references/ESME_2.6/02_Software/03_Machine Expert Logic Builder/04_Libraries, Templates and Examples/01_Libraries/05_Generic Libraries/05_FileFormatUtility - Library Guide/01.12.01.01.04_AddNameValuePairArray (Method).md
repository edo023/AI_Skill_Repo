...
![](images/T003225427.gif)

## Functional Description

Adds a name/value pair to the STRING that is being processed with the value being of type ARRAY.

After the method AddNameValuePairArray has been called, the ARRAY which represents the value that corresponds to the specified name is open.
...
Calling the method AddNameValuePairArray adds the text marked in bold in the example to the STRING:
