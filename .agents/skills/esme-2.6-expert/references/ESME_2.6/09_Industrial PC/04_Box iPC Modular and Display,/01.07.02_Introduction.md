...
oThe Box iPC and display are only permitted for operation in closed rooms.

oThe display cannot be situated in direct sunlight.

oThe Box iPC vent holes must not be covered.

oWhen mounting the display, do not exceed the allowed mounting angle.
