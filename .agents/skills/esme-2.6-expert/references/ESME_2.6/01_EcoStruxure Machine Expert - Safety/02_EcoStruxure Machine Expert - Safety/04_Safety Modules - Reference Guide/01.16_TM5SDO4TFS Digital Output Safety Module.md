# TM5SDO4TFS Digital Output Safety Module (SLCv2)
...
Output safety-related module, 4 safety-related output channels.

0.5 A rated output current, 2 A total rated current.
