# TM5SDM8TBFS Digital Mixed Safety Module (SLCv2)
...
Digital mixed safety-related module, 6 safety-related input channels, 6 pulse outputs, 2 standard (non-safety-related) input channels, input filter configurable by software.

2 safety-related semiconductor outputs, Type B, 0.5 A rated output current, 1 A total rated current.
...
## Group: SafeDigitalInput01 up to SafeDigitalInput06
...
![](images/PulseSources_6channels.PNG)
