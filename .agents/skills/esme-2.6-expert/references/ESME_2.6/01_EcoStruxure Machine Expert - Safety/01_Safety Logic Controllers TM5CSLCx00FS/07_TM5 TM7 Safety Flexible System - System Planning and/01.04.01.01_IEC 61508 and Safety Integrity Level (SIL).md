...
The TM5/TM7 Safety-related I/O modules are a Safety-Related System certified according to IEC 61508 by TÜV Nord.
...
Safety-related functions are executed to achieve and maintain the defined safe state of a system. The IEC 61508 specifies four levels of safety performance for a safety-related function. These are called Safety Integrity Levels (SIL), ranging from 1 (the lowest) to 4 (the highest). The TM5/TM7 Safety-related I/O modules are certified for use in SIL 3 applications in which the de-energized state is the defined safe state.
