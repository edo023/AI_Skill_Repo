# TM5SDO4TFS Presentation

## Main Features

The following table describes the main features of the Safety Digital Output module TM5SDO4TFS:
...
| --- | --- | --- | --- |
| 2 | TM5SDO4TFS | TM5 Safety Digital Output module | red |
...
This figure presents the TM5SDO4TFS status LED indicators:

![](images/T002913562.gif)
