# TM5SDO4TAFS Presentation

## Main Features

The following table describes the main features of the Safety Digital Output module TM5SDO4TAFS:
...
| --- | --- | --- | --- |
| 2 | TM5SDO4TAFS | TM5 Safety Digital Output module | red |
...
This figure presents the TM5SDO4TAFS status LED indicators:

![](images/T002913565.gif)
...
| LED indicator | Color | Status | Description |
| --- | --- | --- | --- |
| **1**  **2**  **3**  **4** | red | on | Indicates either that an error has been detected for the corresponding output or that the safety-related output is being used as a non-safety-related output.  NOTE: During the start-up phase, the channel LED indicators are steady red. |
