...
The SOS function monitors the drive at standstill with active position control performed by the standard (non-safety-related) controller and position monitoring performed by the drive.
