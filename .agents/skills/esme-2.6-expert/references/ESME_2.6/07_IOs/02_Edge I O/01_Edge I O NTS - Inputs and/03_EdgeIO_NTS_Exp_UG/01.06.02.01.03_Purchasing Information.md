...
The following figure presents the elements of the Modicon Edge I/O NTS NTSEDT0810 module:

![](images/DD00812546.png)

| Number | Reference | Description |
| --- | --- | --- |
| 1 | NTSEDT0810K | Base + Module (kit)  NOTE: The module and its corresponding base can be purchased as a kit. |
| 2 | NTSXBA0100H | Spare Base, 1 Slot, for Input/Output Common or Expert Module, Hardened |
| 3 | NTSEDT0810 | Timestamped Discrete Output Module, 8 Outputs |
