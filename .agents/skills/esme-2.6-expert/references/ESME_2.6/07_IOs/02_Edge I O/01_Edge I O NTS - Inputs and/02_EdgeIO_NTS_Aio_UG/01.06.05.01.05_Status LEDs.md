...
The following figure presents the NTSACI0802X/NTSACI0802XH status LEDs:

![](images/DD00833152.png)
...
| ON | Regular Flash | Regular Flash | Indicates:  * Broken wire detection. * 24 Vdc loop power error detection. * Overflow/underflow error detection. |
