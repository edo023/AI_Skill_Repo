...
This guide describes the implementation of Modicon Edge I/O NTS discrete modules. It provides the description, characteristics, wiring diagrams and configuration details for Modicon Edge I/O NTS discrete modules.

## Validity Note

This document has been updated for the release of Modicon Edge I/O NTS discrete modules firmware versions available at the publication date of this document.
