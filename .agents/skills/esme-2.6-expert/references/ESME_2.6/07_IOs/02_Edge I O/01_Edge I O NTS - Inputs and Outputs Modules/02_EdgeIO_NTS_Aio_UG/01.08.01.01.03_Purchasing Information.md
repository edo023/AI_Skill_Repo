...
The following figure shows the elements of the Modicon Edge I/O NTS NTSAMO0210/NTSAMO0210H output modules:

![](images/DD00810276.png)

| Number | Reference | Description |
| --- | --- | --- |
| 1 | NTSAMO0210K | Base + Module (kit) NOTE: The module and its corresponding base can be purchased as a kit. |
| NTSAMO0210HK |
| 2 | NTSXBA0100H | Spare Base, 1 Slot, for Input/Output Common or Expert Module, Hardened |
| 3 | NTSAMO0210 | Analog Output Module, 2 Isolated Outputs, Current, Voltage |
| NTSAMO0210H | Analog Output Module, 2 Isolated Outputs, Current, Voltage, Hardened |
