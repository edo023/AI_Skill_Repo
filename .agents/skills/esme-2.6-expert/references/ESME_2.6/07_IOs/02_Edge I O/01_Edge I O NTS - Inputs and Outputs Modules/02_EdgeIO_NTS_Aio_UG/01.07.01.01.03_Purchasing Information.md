...
The following figure shows the elements of the Modicon Edge I/O NTS NTSART0603 input module:

![](images/DD00811296.png)

| Number | Reference | Description |
| --- | --- | --- |
| 1 | NTSART0603K | Base + Module (kit) NOTE: The module and its corresponding base can be purchased as a kit. |
| 2 | NTSXBA0100H | Spare Base, 1 Slot, for Input/Output Common or Expert Module, Hardened |
| 3 | NTSART0603 | Temperature Input Module, 6 Differential Inputs, RTD, Thermistor, 2-/3-wire |
