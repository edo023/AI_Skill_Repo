...
The following figure presents the NTSDDO1602 status LEDs:

![](images/DD00833254.png)

The following table describes the status of LEDs:

| R (Green) | E (Red) | OUT0...15 (Green) | Description |
| --- | --- | --- | --- |
...
| ON | Regular Flash | Regular Flash | Indicates that a short circuit error is detected. |
