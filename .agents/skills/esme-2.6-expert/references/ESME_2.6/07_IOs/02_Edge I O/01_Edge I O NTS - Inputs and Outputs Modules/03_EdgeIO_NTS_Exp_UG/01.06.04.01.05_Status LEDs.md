...
The following figure presents the NTSEDM0822 status LEDs:

![](images/DD00833267.png)

The following table describes the status of LEDs:

| **R**  (Green) | **E**  (Red) | **IN0...3**  (Green) | **OUT0...3**  (Green) | Description |
| --- | --- | --- | --- | --- |
...
| ON | OFF | ON | - | Indicates that the corresponding input channel is activated. |
| ON | OFF | OFF | - | Indicates that the corresponding input channel is deactivated. |
