...
The following figure presents the NTSAMO0400/NTSAMO0400H status LEDs:

![](images/DD00833224.png)
...
| ON | Regular Flash | - | Module in fallback state. |
| ON | Regular Flash | Regular Flash | Indicates:  * Broken wire detection. * Short circuit detection. * Overflow/underflow error detection. * DAC power error detection. |
