...
The following figure shows the elements of the Modicon Edge I/O NTS NTSDAI0404H input module:

![](images/DD00810268.png)

| Number | Reference | Description |
| --- | --- | --- |
| 1 | NTSDAI0404HK | Base + Module (kit) NOTE: The module and its corresponding base can be purchased as a kit. |
| 2 | NTSXBA0100H | Spare Base, 1 Slot, for Input/Output Common or Expert Module, Hardened |
| 3 | NTSDAI0404H | Discrete Input Module, 4 Inputs, 100...120 Vac, 1-/2-wire, Hardened |
