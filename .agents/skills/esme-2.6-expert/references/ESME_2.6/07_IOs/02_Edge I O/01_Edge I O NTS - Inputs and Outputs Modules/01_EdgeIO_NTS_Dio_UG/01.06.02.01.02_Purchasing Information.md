...
The following figure shows the elements of the Modicon Edge I/O NTS NTSDDI0602 input module:

![](images/DD00811296.png)

| Number | Reference | Description |
| --- | --- | --- |
| 1 | NTSDDI0602K | Base + Module (kit) NOTE: The module and its corresponding base can be purchased as a kit. |
| 2 | NTSXBA0100H | Spare Base, 1 Slot, for Input/Output Common or Expert Module, Hardened |
| 3 | NTSDDI0602 | Discrete Input Module, 6 Inputs, 24 Vdc, Sink, 1-/2-/3-wire |
