...
The following figure shows the elements of the Modicon Edge I/O NTS NTSAMI0400 input module:

![](images/DD00811813.png)

| Number | Reference | Description |
| --- | --- | --- |
| 1 | NTSAMI0400K | Base + Module (kit) NOTE: The module and its corresponding base can be purchased as a kit. |
| 2 | NTSXBA0100H | Spare Base, 1 Slot, for Input/Output Common or Expert Module, Hardened |
| 3 | NTSAMI0400 | Analog Input Module, 4 Inputs, Current, Voltage, 2-wire |
