...
The following figure shows the elements of the Modicon Edge I/O NTS NTSAMO0400/NTSAMO0400H output modules:

![](images/DD00811813.png)

| Number | Reference | Description |
| --- | --- | --- |
| 1 | NTSAMO0400K | Base + Module (kit) NOTE: The module and its corresponding base can be purchased as a kit. |
| NTSAMO0400HK |
| 2 | NTSXBA0100H | Spare Base, 1 Slot, for Input/Output Common or Expert Module, Hardened |
| 3 | NTSAMO0400 | Analog Output Module, 4 Outputs, Current, Voltage |
| NTSAMO0400H | Analog Output Module, 4 Outputs, Current, Voltage, Hardened |
