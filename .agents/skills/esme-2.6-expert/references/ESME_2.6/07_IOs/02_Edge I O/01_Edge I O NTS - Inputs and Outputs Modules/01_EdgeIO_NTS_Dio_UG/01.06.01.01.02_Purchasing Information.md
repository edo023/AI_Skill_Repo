...
The following figure shows the elements of the Modicon Edge I/O NTS NTSDDI0402/NTSDDI0402H input modules:

![](images/DD00810276.png)

| Number | Reference | Description |
| --- | --- | --- |
| 1 | NTSDDI0402K | Base + Module (kit) NOTE: The module and its corresponding base can be purchased as a kit. |
| NTSDDI0402HK |
| 2 | NTSXBA0100H | Spare Base, 1 Slot, for Input/Output Common or Expert Module, Hardened |
| 3 | NTSDDI0402 | Discrete Input Module, 4 Inputs, 24 Vdc, Sink, Diagnostics, 1-/2-/3-wire |
| NTSDDI0402H | Discrete Input Module, 4 Inputs, 24 Vdc, Sink, Diagnostics, 1-/2-/3-wire, Hardened |
