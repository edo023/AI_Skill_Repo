...
The following figure presents the NTSDRA0615 status LEDs:

![](images/DD00833247.png)

The following table describes the status of LEDs:

| R (Green) | E (Red) | OUT0...5 (Green) | Description |
| --- | --- | --- | --- |
...
| ON | - | ON | Indicates that the corresponding output channel is activated. |
| ON | - | OFF | Indicates that the corresponding output channel is deactivated. |
...
| ON | Regular Flash | Regular Flash | Indicates one of the following:  * Broken wire detection. * Short circuit detection. |
