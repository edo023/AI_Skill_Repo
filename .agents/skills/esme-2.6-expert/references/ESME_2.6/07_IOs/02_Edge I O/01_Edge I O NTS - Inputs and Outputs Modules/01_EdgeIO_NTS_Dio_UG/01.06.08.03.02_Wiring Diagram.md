...
The input channels of the NTSDAI0404H module require one shared external 120 Vac power supply connected to the terminal block.
...
The following figure illustrates an example of 1-/2-wire connection inputs with a shared external power supply:

![](images/DD00725950.png)
