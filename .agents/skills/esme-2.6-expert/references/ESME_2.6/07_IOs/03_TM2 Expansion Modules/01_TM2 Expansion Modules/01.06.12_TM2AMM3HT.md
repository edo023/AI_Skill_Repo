...
This expansion module is a 2-point input/1-point output module with a terminal block.

For further hardware information, refer to [TM2AMM3HT](../../../../../../api/crossBook?lang=en-US&virtualBookName=tm2aiohw&topicID=D_RU_0004718_1).
...
![G-RU-0010591.4.gif-high.gif](images/G-RU-0010591.4.gif-high.gif)
...
NOTE: When the value set by the controller is lower than the configured range, the analog output of the module configured in 4...20 mA can be lower than 4 mA.
