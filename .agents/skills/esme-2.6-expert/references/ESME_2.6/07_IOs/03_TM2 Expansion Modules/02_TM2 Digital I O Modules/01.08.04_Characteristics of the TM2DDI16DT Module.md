...
This section provides a description of the electrical and the input characteristics of the TM2DDI16DT module.
...
| Current draw on 5 Vdc internal bus | 40 mA (all inputs on)  5 mA (all inputs off) |
