...
TM2DDO16UK is a 16-channel, transistor output module.
...
![G-GR-0005863.2.gif](images/G-GR-0005863.2.gif)

oThe COM0(-) terminals are connected together internally.

oThe +V terminals are connected together internally.

oConnect an appropriate fuse for the load, not to exceed 0.125 A on the outputs and not to exceed 2 A on the power supply.
