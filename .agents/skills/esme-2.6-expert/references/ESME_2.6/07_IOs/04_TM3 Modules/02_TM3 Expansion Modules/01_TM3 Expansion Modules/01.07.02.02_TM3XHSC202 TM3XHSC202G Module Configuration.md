...
| --- | --- | --- | --- |
| Latch | No\*  Yes | Allows incoming pulses with amplitude widths shorter than the controller scan time to be captured and recorded. | Use latch inputs in the task configured in the [Bus cycle task](D-SE-0032519.html#D-SE-0032519__D-SE-0032519.17). |
| Filter | 0.000 ms  0.001 ms  0.002 ms  0.005 ms  0.01 ms  0.05 ms  0.08 ms  0.5 ms  1 ms  4 ms\*  12 ms | Reduces the effect of noise, such as contact bounce or other transient interference, on a controller input. | Increased filter times reduce the effective speed of the high speed counter. |
