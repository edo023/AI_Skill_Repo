# TM3DI16 / TM3DI16G Characteristics

## Introduction

This section provides a description of the input characteristics of TM3DI16 / TM3DI16G expansion modules.
...
The following diagrams show the external dimensions for the TM3DI16 / TM3DI16G expansion modules:
...
The table below describes the inputs characteristics of the TM3DI16 / TM3DI16G:

| Characteristic | | Value | |
| --- | --- | --- | --- |
| Number of input channels | | 16 inputs | |
| Number of channels groups | | 1 common line on 4 terminals (2 per connector) for 16 channels | |
...
When using TM3DI16 / TM3DI16G:

![](images/T001663723.gif)
