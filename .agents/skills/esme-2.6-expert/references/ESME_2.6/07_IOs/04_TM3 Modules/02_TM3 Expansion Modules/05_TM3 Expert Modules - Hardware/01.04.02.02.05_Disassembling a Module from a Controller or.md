...
| 3 | Push up the [locking device](PhysicalDescription-99C5AC6D.html) from the bottom of the module to disengage it from the controller or the receiver module. |
