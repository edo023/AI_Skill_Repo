# TM3DM32R Characteristics

## Introduction

This section provides a description of the electrical and input/output characteristics of the TM3DM32R expansion modules.
...
The following diagrams show the external dimensions for the TM3DM32R expansion modules:

![](images/0000875611.GIF.gif)

**\*** 8.5 mm (0.33 in) when the clamp is pulled out.

## Input Characteristics

The table below describes the input characteristics of the TM3DM32R:
...
| Turn on time | | 4 ms | |
| Turn off time | | 4 ms | |
| De-rating | 0...55 °C  (32...131 °F) | See [Input de-rating](#Characteristics-2C253DC8__InputDe-rating-2C8C994A) | |
...
The table below describes the output characteristics of the TM3DM32R:
...
| De-rating | 0...55 °C  (32...131 °F) | See [Output de-rating](#Characteristics-2C253DC8__OutputDe-rating-2C8CA459) |
...
This table describes the power limitation of the TM3DM32R expansion modules depending on the voltage, the type of load, and the number of operations required.
