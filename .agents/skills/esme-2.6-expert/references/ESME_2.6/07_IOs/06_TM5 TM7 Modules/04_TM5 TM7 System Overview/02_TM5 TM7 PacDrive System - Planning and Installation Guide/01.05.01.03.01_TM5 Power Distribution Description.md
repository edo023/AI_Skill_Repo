...
| --- | --- | --- | --- |
| [Distributed](D-SE-0015375.html#D-SE-0015375) | First  24 Vdc I/O power segment | The IPDM | The last remote expansion module or the first  PDM (from left to right) of the configuration |
...
| ... | ... | ... |
| Remote | First  24 Vdc I/O power segment | The Receiver module | The last remote expansion module or the first PDM (from left to right) of the configuration |
| Second  24 Vdc I/O power segment | The first PDM (from left to right) of the configuration. | The last expansion module or the second PDM (from left to right) of the configuration. |
| ... | ... | ... |
