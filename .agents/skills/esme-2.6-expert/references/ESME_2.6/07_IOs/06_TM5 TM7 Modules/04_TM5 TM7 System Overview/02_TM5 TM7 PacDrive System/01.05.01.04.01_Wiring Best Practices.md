...
To ground the shielded cables, refer to the section [Grounding the TM5 System](D-SE-0002601.html#D-SE-0002601).

This table provides the wire sizes to use with the removable terminal blocks TM5ACTB06, TM5ACTB12, TM5ACTB12PS and TM5ACTB32:

![](images/T002913386.gif)

This table provides the wire sizes to use with the removable terminal block TM5ACTB16:
...
NOTE: To help prevent a terminal block from being inserted incorrectly, ensure that each terminal block and electronic module is clearly and uniquely [coded](D-SE-0000888.html#D-SE-0000888).

## TM5 Strain Relief Using Cable Tie

There are 2 methods to reduce the stress on cables:

* The [terminal blocks](D-SE-0015379.html#D-SE-0015379__D-SE-0015379.7) have slots to attach cable ties. A cable tie can be fed through this slot to secure cables and wires to reduce stress between them and the terminal block connections.
