...
| 2 | Remove the terminal block from the rightmost slice:   | 1 | Push down on the locking lever on the terminal block. | | 2 | Rotate the terminal block out and down. | |  |
| 3 | Remove the locking plate from the rightmost slice:   | 1 | Use a screwdriver to unhook the locking clip of the right locking plate. | | 2 | Pull the locking plate off the bus base and electronic module. | |  |
