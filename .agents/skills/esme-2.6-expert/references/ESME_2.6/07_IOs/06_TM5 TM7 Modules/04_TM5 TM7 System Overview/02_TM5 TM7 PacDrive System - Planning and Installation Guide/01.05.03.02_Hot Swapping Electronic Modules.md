...
Before initiating a hot swap operation, confirm that the electronic module type is [approved for hot swapping](#D-SE-0015398__D-SE-0015398.8).
...
You need to understand and plan for the effects of hot-swapping certain modules. Hot-swapping modules that control power distribution to other modules, for example, can impact your machine or process. Power Distribution Modules (PDM), Interface Power Distribution Modules (IPDM), Common Distribution modules, Sercos III Bus Interface Modules, and Transmitter and Receiver modules all either distribute power or communications to other electronic modules. Disconnecting the connector to these modules will interrupt power or communications to the modules they service.
