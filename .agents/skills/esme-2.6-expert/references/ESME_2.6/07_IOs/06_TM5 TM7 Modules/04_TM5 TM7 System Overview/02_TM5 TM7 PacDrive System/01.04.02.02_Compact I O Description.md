...
| WARNING | |
| --- | --- |
|  | UNINTENDED EQUIPMENT OPERATION  Do not attempt to hot swap TM5 Compact I/O.  Failure to follow these instructions can result in death, serious injury, or equipment damage. |

The following figure shows a TM5 Compact I/O as the second component of a remote island:

![](images/T002913537.gif)
...
* analog output electronic modules

Every electronic module channel has a status LED.

Mechanical and hardware features are described in the [*Modicon TM5 Compact I/O Modules Hardware Guide*](../../../../../api/crossBook?lang=en-US&virtualBookName=tm5comhw&topicID=D_SE_0009768).
...
NOTE: The [terminal blocks](D-SE-0015379.html#D-SE-0015379__D-SE-0015379.7) associated to the compact I/O are 12-pin white terminal blocks.
