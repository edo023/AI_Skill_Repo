...
The following figure shows the pin assignments for the I/O connectors of the TM7BAM4CLA block:

| Connection | Pin | M12 Input | M12 Output |
| --- | --- | --- | --- |
| G-SE-0006868.1.gif | 1 | 24 Vdc sensor supply | Analog output + |
| 2 | Analog input + | 24 Vdc actuator supply |
| 3 | 0 Vdc | Analog output - (0 Vdc) |
| 4 | Analog input - | 0 Vdc |
| 5 | Shield | Shield |
