...
The following figure shows the pin assignments for the input connectors and terminal temperature compensation of the TM7BAI4PLA:

| Pin | M12 input connectors  G-SE-0006868.1.gif | TM7BAI4PLA thermocouple plug  G-SE-0007209.1.gif |
| --- | --- | --- |
| 1 | N.C. | Temperature compensation input |
| 2 | Analog input + | Analog input + |
| 3 | 0 Vdc | 0 Vdc |
| 4 | Analog input - | Analog input - |
| 5 | Shield | Shield |
