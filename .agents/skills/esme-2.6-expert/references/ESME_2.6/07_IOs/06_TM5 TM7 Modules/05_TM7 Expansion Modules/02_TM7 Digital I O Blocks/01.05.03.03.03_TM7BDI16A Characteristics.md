...
The table below provides the input characteristics of the TM7BDI16A block:
...
| Connection type | M12, female connector, 5-pin | |
...
The table below provides the power supply for the sensors of theTM7BDI16A block:
