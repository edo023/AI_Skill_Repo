...
The following figure shows the pin assignments for the I/O connectors of the TM7BDM16A block:

| Connection | Pin | M12 input / output |
| --- | --- | --- |
| G-SE-0006868.1.gif | 1 | 24 Vdc sensor / actuator supply |
| 2 | DI/DO: input/output signal channel 1 |
| 3 | 0 Vdc |
| 4 | DI/DO: input/output signal channel 2 |
| 5 | N.C. |
