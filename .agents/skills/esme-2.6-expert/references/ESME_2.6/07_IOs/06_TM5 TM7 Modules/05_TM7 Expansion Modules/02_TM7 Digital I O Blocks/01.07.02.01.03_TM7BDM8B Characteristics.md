...
The table below provides the general characteristics of the TM7BDM8B block:

| General characteristics | |
| --- | --- |
| Rated power supply voltage | 24 Vdc |
| Power supply range | 18...30 Vdc |
| 24 Vdc I/O power segment current draw | 105 mA |
...
The table below provides the output characteristics of the TM7BDM8B block:
...
| Total output current for the block | | 4 A max. | |
...
| Inductive load | See the [switching inductive load characteristics](#XREF_D_SE_0008162_8) | |
...
The table below provides the power supply for the sensors and actuators of the TM7BDM8B block:
