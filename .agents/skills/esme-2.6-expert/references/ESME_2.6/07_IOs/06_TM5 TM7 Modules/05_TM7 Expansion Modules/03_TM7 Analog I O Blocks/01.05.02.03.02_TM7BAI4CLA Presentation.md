...
The table below provides the connector and channel assignments of the TM7BAI4CLA block:
...
The following figure shows the status LEDs of the TM7BAI4CLA block:
...
The table below provides describes the TM7 bus status LEDs of the TM7BAI4CLA block:
...
The table below provides the input status LEDs of the TM7BAI4CLA block:
...
The table below provides the input block status LEDs of the TM7BAI4CLA block:
