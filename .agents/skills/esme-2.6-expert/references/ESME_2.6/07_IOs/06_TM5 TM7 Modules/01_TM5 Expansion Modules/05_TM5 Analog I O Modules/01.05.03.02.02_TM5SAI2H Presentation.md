...
The following figure shows the slice with a TM5SAI2H:

![G-SE-0000922.2.gif-high.gif](images/G-SE-0000922.2.gif-high.gif)

The table below shows the model numbers for the terminal block and bus base associated to TM5SAI2H:

| Number | Model Number | Description | Color |
| --- | --- | --- | --- |
| 1 | TM5ACBM11  or  TM5ACBM15 | Bus base    Bus base with address setting | White    White |
| 2 | TM5ASAI2H | Electronic module | White |
