# TM5SDO6T Characteristics

## Introduction

This is the description characteristics for the TM5SDO6T electronic module.
...
The table below describes the general characteristics of the TM5SDO6T electronic module:
...
| Power dissipation | 1.20 W maximum |
| Weight | 25 g (0.9 oz) |
| ID code for firmware update | 7064 dec |

## Output Characteristics

The table below describes the output characteristics of the TM5SDO6T electronic module:
...
| Total output current | | 3 A maximum |
...
| Inductive load | See the [switching inductive load characteristics](#D-SE-0002474__D-SE-0002474.7). |
...
The curves below provide the switching inductive load characteristics for the TM5SDO6T electronic module.
