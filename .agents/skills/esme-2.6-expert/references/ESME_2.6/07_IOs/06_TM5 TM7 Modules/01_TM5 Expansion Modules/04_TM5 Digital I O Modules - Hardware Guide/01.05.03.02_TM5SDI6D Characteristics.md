# TM5SDI6D Characteristics

## Introduction

This is the description characteristics for the TM5SDI6D electronic module. See also [Environmental Characteristics](D-SE-0002647.html#D-SE-0002647).
...
The table below describes the general characteristics of the TM5SDI6D electronic module:
...
| TM5 Bus 5 Vdc current draw | 30 mA |
| Power dissipation | 1.03 W maximum |
| Weight | 25 g (0.9 oz) |
| ID code for firmware update | 7059 dec |
