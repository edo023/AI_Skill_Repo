...
The table below describes the main characteristics of the TM5SAI4L electronic module:
...
The following figure shows the slice with a TM5SAI4L:

![G-SE-0000922.2.gif-high.gif](images/G-SE-0000922.2.gif-high.gif)

The table below shows the model numbers for the terminal block and bus base associated to TM5SAI4L:

| Number | Model Number | Description | Color |
| --- | --- | --- | --- |
| 1 | TM5ACBM11  or  TM5ACBM15 | Bus base    Bus base with address setting | White    White |
| 2 | TM5ASAI4L | Electronic module | White |
