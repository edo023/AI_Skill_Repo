# TM5SDO4T Presentation

## Main Characteristics

The table below describes the main characteristics of the TM5SDO4T electronic module:
...
The following illustration shows the TM5SDO4T:

![](images/T000367271.gif)

The table below shows the model numbers for the terminal blocks and the bus bases associated with the TM5SDO4T:

| Number | Model Number | Description | Color |
| --- | --- | --- | --- |
| 1 | TM5ACBM11  or  TM5ACBM15 | Bus base  Bus base with address setting | White  White |
| 2 | TM5SDO4T | Electronic Module | White |
...
The following illustration shows LEDs for TM5SDO4T:

![](images/T000367384.gif)

The table below shows the TM5SDO4T status LEDs:
