...
The following figure shows the wiring diagram for TM5SAI2H:

![G-SE-0003494.2.gif](images/G-SE-0003494.2.gif)
...
| Warning_Color.gifWARNING |
| UNINTENDED EQUIPMENT OPERATION |
| oDo not place 16\_bit analog input modules next to each other.  oDo not place 16\_bit analog input modules in direct proximity to equipment that generates electromagnetic interference.  oInsert at least one none interfering slice between any 16-bit analog input modules and any interference generating equipment. |
| Failure to follow these instructions can result in death, serious injury, or equipment damage. |
