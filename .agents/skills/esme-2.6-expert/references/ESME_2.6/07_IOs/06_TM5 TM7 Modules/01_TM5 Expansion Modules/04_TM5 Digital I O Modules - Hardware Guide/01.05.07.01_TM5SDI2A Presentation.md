# TM5SDI2A Presentation

## Main Characteristics

The table below describes the main characteristics of the TM5SDI2A electronic module:
...
The following illustration shows the TM5SDI2A:

![](images/T000367271.gif)

The table below shows the model numbers for the terminal block and the bus base associated with the TM5SDI2A:

| Number | Model Number | Description | Color |
| --- | --- | --- | --- |
| 1 | TM5ACBM12 | Bus base | Black |
| 2 | TM5SDI2A | Electronic Module | Black |
...
The following illustration shows the LEDs for TM5SDI2A:

![](images/T000367378.gif)

The table below shows the TM5SDI2A status LEDs:
