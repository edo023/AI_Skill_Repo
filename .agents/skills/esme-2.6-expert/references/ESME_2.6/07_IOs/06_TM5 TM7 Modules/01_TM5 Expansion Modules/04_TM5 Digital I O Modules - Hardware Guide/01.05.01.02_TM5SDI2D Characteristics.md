# TM5SDI2D Characteristics

## Introduction

This is the description characteristics for the TM5SDI2D electronic module. See also [Environmental Characteristics](D-SE-0002647.html#D-SE-0002647).
...
The table below describes the general characteristics of the TM5SDI2D electronic module:
...
| 24 Vdc I/O segment current draw | 12 mA (all inputs On) |
| TM5 Bus 5 Vdc current draw | 24 mA |
| Power dissipation | 0.41 W maximum |
| Weight | 25 g (0.9 oz) |
| ID code for firmware update | 7053 dec |

## Input Characteristics

The table describes the input characteristics of the TM5SDI2D electronic module:
...
The table describes the sensor supply of the TM5SDI2D electronic module:
