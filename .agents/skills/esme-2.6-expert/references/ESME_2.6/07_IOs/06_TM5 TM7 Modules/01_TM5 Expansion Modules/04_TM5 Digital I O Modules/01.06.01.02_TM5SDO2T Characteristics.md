# TM5SDO2T Characteristics

## Introduction

This is the description characteristics for TM5SDO2T electronic module.
...
The table below describes the general characteristics of the TM5SDO2T electronic module:
...
| 24 Vdc I/O segment current draw | 14 mA |
| TM5 bus 5 Vdc current draw | 26 mA |
| Power dissipation | 0.57 W maximum |
| Weight | 25 g (0.9 oz) |
| ID code for firmware update | 7062 dec |

## Output Characteristics

The table below describes the output characteristics of the TM5SDO2T electronic module:
...
| Inductive load | See the [switching inductive load characteristics](#D-SE-0002422__D-SE-0002422.8). |
...
The table below describes the actuator supply of the TM5SDO2T electronic module:
...
The curves below provide the switching inductive load characteristics for the TM5SDO2T electronic module.
