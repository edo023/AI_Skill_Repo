# TM5SDO2T Presentation

## Main Characteristics

The table below describes the main characteristics of the TM5SDO2T electronic module:

| Main Characteristics | |
| --- | --- |
| Number of outputs channels | 2 |
...
The following illustration shows the TM5SDO2T:

![](images/T000367271.gif)

The table below shows the model numbers for the terminal blocks and the bus bases associated with the TM5SDO2T:

| Number | Model Number | Description | Color |
| --- | --- | --- | --- |
| 1 | TM5ACBM11  or  TM5ACBM15 | Bus base  Bus base with address setting | White  White |
| 2 | TM5SDO2T | Electronic Module | White |
...
The following illustration shows LEDs for TM5SDO2T:

![](images/T000367383.gif)

The table below shows the TM5SDO2T status LEDs:
