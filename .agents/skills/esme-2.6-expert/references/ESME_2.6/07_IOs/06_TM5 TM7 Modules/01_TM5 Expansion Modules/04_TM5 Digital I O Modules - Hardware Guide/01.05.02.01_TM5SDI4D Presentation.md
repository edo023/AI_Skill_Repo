# TM5SDI4D Presentation

## Main Characteristics

The table below describes the main characteristics of the TM5SDI4D electronic module:
...
The following illustration shows the TM5SDI4D:

![](images/T000367271.gif)

The table below shows the model numbers for the terminal blocks and the bus bases associated with the TM5SDI4D:

| Number | Model Number | Description | Color |
| --- | --- | --- | --- |
| 1 | TM5ACBM11  or  TM5ACBM15 | Bus base  Bus base with address setting | White  White |
| 2 | TM5SDI4D | Electronic Module | White |
...
The following illustration shows the LEDs for TM5SDI4D:

![](images/T000367375.gif)

The table below shows the TM5SDI4D status LEDs:
