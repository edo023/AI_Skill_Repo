# TM5SDO4T Characteristics

## Introduction

This is the description characteristics for TM5SDO4T electronic module.
...
The table below describes the general characteristics of the TM5SDO4T electronic module:
...
| 24 Vdc I/O segment current draw | 20 mA |
| TM5 bus 5 Vdc current draw | 32 mA |
| Power dissipation | 0.86 W maximum |
| Weight | 25 g (0.9 oz) |
| ID code for firmware update | 7063 dec |

## Output Characteristics

The table below describes the output characteristics of the TM5SDO4T electronic module:
...
| Total output current | | 2 A maximum |
| Output voltage | | 24 Vdc |
| Output voltage range | | 20.4...28.8 Vdc |
| Voltage drop | | 0.3 Vdc maximum at 0.5 A rated current |
...
| Inductive load | See the [switching inductive load characteristics](#D-SE-0002457__D-SE-0002457.10). |
...
The table below describes the actuator supply of the TM5SDO4T electronic module:
...
The curves below provide the switching inductive load characteristics for the TM5SDO4T electronic module.
