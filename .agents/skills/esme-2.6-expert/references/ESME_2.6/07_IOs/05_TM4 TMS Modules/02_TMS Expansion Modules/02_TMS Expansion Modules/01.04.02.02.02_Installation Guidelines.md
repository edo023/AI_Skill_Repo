...
TMS expansion module is assembled by connecting it to a controller.

The controller and the connected expansion modules can be installed on a top hat section rail (DIN rail), or vertical surface.
