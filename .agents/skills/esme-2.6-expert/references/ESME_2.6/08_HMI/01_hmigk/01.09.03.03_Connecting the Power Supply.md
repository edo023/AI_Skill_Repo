...
![G-SE-0027297.2.gif-high.gif](images/G-SE-0027297.2.gif-high.gif)

oUse SELV (Safety Extra-Low Voltage) circuit and LIM (Limited Energy) circuit for DC input.
...
oSelect a power supply low in noise for between the line and ground. If there is an excessive amount of noise, connect an insulating transformer.
