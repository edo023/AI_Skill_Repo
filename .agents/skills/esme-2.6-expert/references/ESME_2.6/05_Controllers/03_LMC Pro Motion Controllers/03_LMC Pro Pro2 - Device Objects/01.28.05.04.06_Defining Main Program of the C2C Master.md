...
| Step | Action |
| --- | --- |
| 1 | To use the Sercos encoder, the **C2C Encoder Output** object is connected to the **Log. Encoder** object using the function *FC\_SetMasterEncoder*. |
| 2 | The axis state is verified.  If *AxisState* < 3, position control of the axis of the C2C Master (TTS1) and monitoring of the power supply of the C2C Master (TTS1) are enabled. |
...
| 4 | The axis is moved using the *YOffsetGenerator*. |
