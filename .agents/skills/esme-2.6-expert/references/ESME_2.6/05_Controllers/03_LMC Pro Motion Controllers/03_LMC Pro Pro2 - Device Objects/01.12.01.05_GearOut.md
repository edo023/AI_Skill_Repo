...
Displays the gear output (denominator). This only affects the velocity (Parameter Velocity) of the master encoder; it does not affect OffsetVelocity. The velocity of the master encoder is multiplied by GearIn and divided by GearOut.
