...
* The devices are addressed in one of the following ways:
  ...
  + Serial number (Identification mode -> Device number, SerialNumberController / 0, also refer to IdentificationMode and [Device addressing](D-SE-0088091.html#D-SE-0088091))
