...
MasterUserData[0] ... MasterUserData[3] display the application-specific data from the [synchronization master](D-SE-0076436.html#D-SE-0076436) that were sent at the time of the MasterDataTimestamp. The function *FC\_SyncReadMasterUserData()* is available for consistent reading.
