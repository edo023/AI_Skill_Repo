...
The real-time process (RTP) is an important system task. It enables the execution of the real-time tasks at the correct time. Real-time processing is triggered by the Sercos real-time bus during each [bus cycle](D-SE-0073362.html#D-SE-0073362). Processing is then performed in the following steps.
