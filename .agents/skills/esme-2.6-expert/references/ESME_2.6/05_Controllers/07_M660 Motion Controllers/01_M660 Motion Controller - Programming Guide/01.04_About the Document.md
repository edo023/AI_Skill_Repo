...
The present User Guide provides information on configuring and programming Modicon M660 controllers using the programming environment EcoStruxure Machine Expert V2.6.

The present user guide supplements the information provided in the EcoStruxure Machine Expert Programming Guide. Programming Modicon M660 controllers presupposes knowledge of the EcoStruxure Machine Expert Programming Guide.
...
| --- | --- |
| M660 Hardware Guide | [EIO0000005519 (eng)](https://www.se.com/en/download/document/EIO0000005519) |
...
| WARNING | |
| --- | --- |
|  | UNINTENDED EQUIPMENT OPERATION  * Verify that all parameter values used for your machine/process are correct. * Do not disable or circumvent any monitoring functions provided by the hardware and the software of the controller and of any equipment connected to the controller. * Implement all additional monitoring functions and safety-related functions required for your machine/process as identified in your risk assessment. * Verify correct operation and effectiveness of all functions by performing comprehensive tests for all operating states, the defined safe state, and all potential error situations.  Failure to follow these instructions can result in death, serious injury, or equipment damage. |
