...
| `EN_Compare` | `BOOL` | `TRUE` = enables the [comparison operation](D-SE-0006695.html#D-SE-0006695) (using Thresholds 0, 1, 2, 3):   * basic comparison (`TH0`, `TH1`, `TH2`, `TH3` output bits) * reflex (`Reflex0`, `Reflex1` output bits) * events (to trigger external tasks on threshold crossing) |
...
| `HSC_Err` | `BOOL` | `TRUE` = indicates that an error was detected.  Use the [EXPERTGetDiag](D-SE-0006835.html#D-SE-0006835) function block to get more information about this detected error. |
...
| `Reflex0` | `BOOL` | State of Reflex0.  Only active when EN\_Compare is set. |
| `Reflex1` | `BOOL` | State of Reflex1.  Only active when EN\_Compare is set. |
