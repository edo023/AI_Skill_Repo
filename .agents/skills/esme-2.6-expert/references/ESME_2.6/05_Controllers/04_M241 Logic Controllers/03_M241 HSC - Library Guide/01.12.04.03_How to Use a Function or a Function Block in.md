...
| --- | --- |
| `SetRTCDrift` | ``` PROGRAM MyProgram_ST VAR myDrift: SINT(-29..29) := 5; myDay: DAY_OF_WEEK := SUNDAY; myHour: HOUR := 12; myMinute: MINUTE; myRTCAdjust: RTCDRIFT_ERROR; END_VAR ```  ``` myRTCAdjust:= SetRTCDrift(myDrift, myDay, myHour, myMinute); ``` |
