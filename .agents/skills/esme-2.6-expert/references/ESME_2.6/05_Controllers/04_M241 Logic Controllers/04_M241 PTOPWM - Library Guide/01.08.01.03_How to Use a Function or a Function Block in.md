...
| Step | Action |
| --- | --- |
| 1 | Open or create a new POU in Structured Text language.  NOTE: The procedure to create a POU is not detailed here. For more information on adding, declaring and calling POUs, refer to the related [documentation](../../../../../api/crossBook?lang=en-US&virtualBookName=SoMProg&topicID=D_SE_0083406). |
