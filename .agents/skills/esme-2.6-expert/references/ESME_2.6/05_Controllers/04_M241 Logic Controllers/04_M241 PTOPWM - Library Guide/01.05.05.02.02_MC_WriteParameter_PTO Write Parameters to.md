# MC\_WriteParameter\_PTO: Write Parameters to the PTO
...
| `ErrorId` | `PTO_ERROR` | `PTO_ERROR.NoError` | When `Error` is TRUE: code of the [error detected](D-SE-0033053.html#D-SE-0033053). |
