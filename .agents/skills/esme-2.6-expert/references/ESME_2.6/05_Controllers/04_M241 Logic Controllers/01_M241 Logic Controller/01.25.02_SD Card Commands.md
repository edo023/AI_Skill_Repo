...
NOTE: User access rights can only be copied if the Include User Rights button has previously been clicked on the Clone Management subpage of the [Web server](MaintenanceMenu-0B91FC4E.html#MaintenanceMenu-0B91FC4E__D-SE-0002960.38).
...
For more details about this function block, refer to the [Modicon M241 Logic Controller, System Functions and Variables, PLCSystem Library Guide](../../../../../api/crossBook?lang=en-US&virtualBookName=m241sys&topicID=D_SE_0085973).

If you wish to control access to the cloned application in the target controller, you must use the Include users rights button (on the Clone Management subpage of the [Web server](MaintenanceMenu-0B91FC4E.html#MaintenanceMenu-0B91FC4E__D-SE-0002960.38)) of the source controller before doing the clone operation.

For more details about Access Rights, refer to the EcoStruxure Machine Expert [Programming Guide](../../../../../api/crossBook?lang=en-US&virtualBookName=SoMProg&topicID=D_SE_0038269).
...
| 2 | Select if you want to clone the Users Rights. Refer to the Clone Management subpage of the [Web server](MaintenanceMenu-0B91FC4E.html#MaintenanceMenu-0B91FC4E__D-SE-0002960.38). |
