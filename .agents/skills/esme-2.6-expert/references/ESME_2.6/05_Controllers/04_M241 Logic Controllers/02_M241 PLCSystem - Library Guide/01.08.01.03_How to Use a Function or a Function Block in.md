...
| --- | --- |
| `SetRTCDrift` | ``` PROGRAM MyProgram_ST VAR myDrift: SINT (-36..+73) := 5; myDay: sec.DAY_OF_WEEK := SUNDAY; myHour: sec.HOUR := 12; myMinute: sec.MINUTE; myRTCAdjust: sec.RTCDRIFT_ERROR; END_VAR ```  ``` myRTCAdjust:= SetRTCDrift(myDrift, myDay, myHour, myMinute); ``` |
...
This table shows an example of a function block call in ST language:
