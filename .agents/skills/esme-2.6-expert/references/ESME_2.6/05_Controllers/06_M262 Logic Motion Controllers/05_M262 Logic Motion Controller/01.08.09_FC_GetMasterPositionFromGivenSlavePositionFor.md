# FC\_GetMasterPositionFromGivenSlavePositionForInterpolatedCam
...
Determines the position of the master axis on the basis of the position of the subordinate axis when an interpolated cam is being executed.

## Description

Using the function FC\_GetMasterPositionFromGivenSlavePositionForInterpolatedCam, you can determine the position of the master axis on the basis of the position of the subordinate axis. The function works with interpolated cams defined in terms of interpolation data and executed by the function block MC\_CamIn. Refer to the *M262 Synchronized Motion Control Library Guide* for details on the function block MC\_CamIn.
