...
* Copy data from memory to a formatted file. For further information, refer to [Non-Volatile Memory Organization](../../../../../api/crossBook?lang=en-US&virtualBookName=m262prg&topicID=D_SE_0004156).

NOTE: Since file operations require longer time to complete, execute this function block in a low-priority, cyclic task. Adapt the watchdog function for this task to allow sufficient time for the connection. Alternatively, execute this function block in a Freewheeling task. For this type of task, no cycle time is defined.
