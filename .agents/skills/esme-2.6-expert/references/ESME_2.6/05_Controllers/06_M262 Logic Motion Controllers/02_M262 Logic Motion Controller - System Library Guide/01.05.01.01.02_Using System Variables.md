...
EcoStruxure Machine Expert has an auto-completion feature. In a POU, start by entering the system variable structure name (PLC\_R PLC\_W...) followed by a dot. The system variables appear in the Input Assistant. You can select the desired variable or enter the full name manually.

![](images/T002236350.gif)

NOTE: In the example above, after you type the structure name PLC\_R, EcoStruxure Machine Expert offers a pop-up menu of possible component names/variables.
