...
| Output | Type | Comment |
| --- | --- | --- |
| TM3\_GetModuleInternalStatus | [TM3\_ERR\_CODE](D-SE-0032128.html#D-SE-0032128) | Returns TM3\_NO\_ERR (00 hex) if command is correct otherwise returns the ID code of the error. For the purposes of this function block, any returned value other than zero indicates that the module is not compatible with the status request, or that the module has other communication issues. |
