...
| EN\_Sync | BOOL | When SYNC input is configured: if TRUE, allows the setting of the counter value to 0. |
...
| Error | BOOL | TRUE = indicates that an error was detected.  [HSCGetDiag](../Function_Blocks/Function_Blocks-3.htm#XREF_D_SE_0006835_1) function block may be used to get more information about this detected error. |
