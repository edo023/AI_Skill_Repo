...
The [MAST](../glossary/glossary.htm#XREF_D_SE_0024697_150) task can be configured in Freewheeling or Cyclic mode. The MAST task is automatically created by default in Cyclic mode. Its preset priority is medium (15), its preset interval is 20 ms, and its task watchdog service is activated with a time of 100 ms and a sensitivity of 1. Refer to [Task Priorities](M258_-_Tasks-6.htm#XREF_D_SE_0008826_1) for more information on priority settings. Refer to [Task Watchdogs](M258_-_Tasks-5.htm#XREF_D_RU_0004615_1) for more information on watchdogs.
