...
PositionWithoutDelay does not consider manipulation by the Delay parameter of the logical encoder. This allows the "real" position of a physical encoder (e.g. ) to be used for the [TouchProbe function](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.SystemInterface&topicID=D_SE_0085375), even though a value ([-ShaftRefDelay](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Parameter.LXM62Drive&topicID=D_SE_0071497) of the axis) is entered for the Synchronous run of a slave axis in the Delay parameter.
