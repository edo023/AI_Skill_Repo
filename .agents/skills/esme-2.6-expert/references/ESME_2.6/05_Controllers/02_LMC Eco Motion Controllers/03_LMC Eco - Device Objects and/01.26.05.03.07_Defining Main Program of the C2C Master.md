...
| Step | Action |
| --- | --- |
| 1 | To use the Sercos encoder, the **C2C Encoder Input** object is connected to the **Log. Encoder** object using the function *[FC\_SetMasterEncoder](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.SystemInterface&topicID=D_SE_0085311)*. |
| 2 | The axis state is verified.   * If *[AxisState](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Parameter.LXM62Drive&topicID=D_SE_0071486)* < 3, position control of the axis of the C2C Slave (TTS2) and monitoring of the power supply of the C2C Slave (TTS2) are enabled. * If AxisState >= 3, the function block *[FB\_MultiCam](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.PacDriveLib&topicID=D_SE_0087313)* is started. |
