...
NOTE: Depending on the application, observe the dead time caused by DataDelay. This is especially important to consider when you have physical master encoders (SinCos encoders or incremental encoders) that are distributed over the encoder network. A technically better solution might be to use a BT-4/ENC1 bus terminal on PacNet.
