...
A three-layer diagnostic concept is provided for the libraries. This concept is valid for the Technology/Module libraries (for example, the library PD\_PacDrive.lib) and uses enumerations for diagnostic coding.
