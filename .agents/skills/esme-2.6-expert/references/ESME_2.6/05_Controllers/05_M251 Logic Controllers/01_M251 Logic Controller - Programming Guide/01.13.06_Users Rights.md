...
NOTE: Anonymous login can be restored by disabling the user rights in User accounts management subpage of the [Web server](MaintenanceMenu-0B989E57.html#MaintenanceMenu-0B989E57__D-SE-0002960.38).
...
| **(1)** The Access Rights description depends on the Object. Refer to [Predefined Access Rights Needed by Object and Associated Operations](PredefinedAccessRightsNeededByObjec-FE90A581.html). | |
...
NOTE: The importation of user rights into an M251 Logic Controller is only possible if these user rights have been exported from an M241 Logic Controller or M251 Logic Controller.
