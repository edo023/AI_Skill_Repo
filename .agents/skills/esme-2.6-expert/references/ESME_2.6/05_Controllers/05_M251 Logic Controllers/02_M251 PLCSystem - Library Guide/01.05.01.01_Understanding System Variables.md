...
* a structure name that represents the category of system variable. For example, PLC\_R represents a structure name of read-only variables used for the controller diagnostic.
