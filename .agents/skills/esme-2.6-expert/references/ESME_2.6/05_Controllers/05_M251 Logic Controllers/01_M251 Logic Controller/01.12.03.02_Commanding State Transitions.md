...
* By an external call via Modbus request using the PLC\_W.q\_wPLCControl and PLC\_W.q\_uiOpenPLCControl system variables of the [M251 PLCSystem library](../../../../../api/crossBook?lang=en-US&virtualBookName=m251sys&topicID=D_SE_0035734).
...
* By an internal call by the application or an external call via Modbus request using the PLC\_W. q\_wPLCControl and PLC\_W. q\_uiOpenPLCControl system variables of the [M251 PLCSystem library](../../../../../api/crossBook?lang=en-US&virtualBookName=m251sys&topicID=D_SE_0035734).
