...
This output behavior applies in the STOPPED controller state. It also applies to [CAN bus in the HALT controller state](D-SE-0008844.html#D-SE-0008844__CANopenBehaviorInHALTState-3B78DFD0), except if the task defined for the Bus cycle task of the CANopen\_Performance is in Exception, or during ProcessorLoadWatchdog.
