...
| IEC Objects | Allows you to access the device from the IEC application through the listed objects. Displays a monitoring view in online mode. For more information, refer to [IEC Object in CoDeSys Online Help](https://help.codesys.com/webapp/_cds_edt_device_iec_objects;product=codesys;version=3.5.16.0). | – |
