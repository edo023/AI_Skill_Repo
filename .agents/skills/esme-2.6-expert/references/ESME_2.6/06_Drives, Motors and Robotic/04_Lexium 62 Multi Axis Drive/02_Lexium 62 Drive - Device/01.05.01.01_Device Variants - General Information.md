...
* “Standard” - provides standard Lexium LXM62 Drive / Lexium LXM62 Linear Drive functions. No additional functions are supported.
* “Standard Plus” - provides the user functions Encoderless Velocity Control, Torque Limitation, and Brake Check (available via functions *[FC\_BrakeCheckGetState](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.SystemInterface&topicID=D_SE_0090573)* and *[FC\_BrakeCheckStart](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Lib.SystemInterface&topicID=D_SE_0090307)* in the SystemInterface Library). These user functions are not available for Lexium LXM62 Linear Drive.
* “Advanced Plus” - in addition to the Standard Plus features, the device variant supports the user function Incremental Encoder Output. Additionally, a Machine Encoder object can be added to the Lexium LXM62 Drive (not available for Lexium LXM62 Linear Drive).
* “Application defined” - all user functions can be selected. The selection and activation of the device variant and the user functions is done in the application code before the Sercos phase up check (see the section [Using the Device Variant Application defined](#D-SE-0090515)).
...
For a description of the user functions supported by the different device variants and how to use them in the application, refer to the [User Functions](D-SE-0090516.html#D-SE-0090516) chapter.
...
* 1 (device variant “Standard” is used; no user functions are supported)
* 2 (device variant “Standard Plus” is used)
* 3 (device variant “Advanced Plus” is used)
