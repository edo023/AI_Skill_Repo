...
The maximum ramp-down time is not monitored if asynchronous motors without encoder are used (in open-loop V / f control mode, ControlMode = open-loop control / 1).
