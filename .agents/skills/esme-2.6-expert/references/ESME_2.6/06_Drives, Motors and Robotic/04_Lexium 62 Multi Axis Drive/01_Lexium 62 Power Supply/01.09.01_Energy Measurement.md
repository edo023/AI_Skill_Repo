...
* The electrical energy Welectrical (power supply) (see parameter ElectricalEnergyPowerSupply) that was received by the device
* The thermal energy loss in the braking resistor Wdissipated (brake resistor) (see parameter DissipatedEnergyPowerSupply)
* The electrical energy Welectrical (drive) (see parameter *[ElectricalEnergyDrive](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Parameter.LXM62Drive&topicID=D_SE_0071859)*) that was received by the drive from the DC bus
* The thermal energy loss in the motor winding Wdissipated (motor) (see parameter *[DissipatedEnergyDrive](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Parameter.LXM62Drive&topicID=D_SE_0071860)*)
* The mechanical energy Wmechanical (see parameter *[MechanicalEnergy](../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Parameter.LXM62Drive&topicID=D_SE_0071861)*) delivered respectively received by the motor
...
* The electrical energy Welectrical (power supply) (see parameter ElectricalEnergyPowerSupply) that was received by the device
* The thermal energy loss in the braking resistor Wdissipated (brake resistor) (see parameter DissipatedEnergyPowerSupply) that was received by the device
