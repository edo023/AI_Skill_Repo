...
NOTE: Before entering ControllerStopJerk, verify the parameters [MaxAcc](General_2-4.htm#XREF_D_SE_0071526_1) and [StopTimeLim](General_2-9.htm#XREF_D_SE_0071531_1). Changing these parameters at a later stage does not influence ControllerStopJerk. However, when reducing ControllerStopDec , the time and the necessary position range for a stop increases.
