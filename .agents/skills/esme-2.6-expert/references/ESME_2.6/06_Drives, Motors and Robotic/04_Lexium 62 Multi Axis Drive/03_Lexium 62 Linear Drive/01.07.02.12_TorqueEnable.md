...
The parameter is used to enable the torque for the drive. If TorqueEnable is set to FALSE during the operation (AxisState > 2), then the [Reaction AD](../../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Diagnostic&topicID=D_SE_0063389_1) is triggered.
