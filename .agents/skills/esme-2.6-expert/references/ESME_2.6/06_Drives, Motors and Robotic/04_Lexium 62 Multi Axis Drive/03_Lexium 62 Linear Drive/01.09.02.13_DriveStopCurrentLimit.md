...
The DriveStopCurrentLimit parameter is used for the limitation of the peak current during a [device reaction](../../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Diagnostic&topicID=D_SE_0063389_1) BD1 or BD2 in the drive. If for this parameter, a value between 10% and 100% of [MaxDrivePeakCurrent](General_2-6.htm#XREF_D_SE_0071528_1) is entered, then this value is used as peak current during the drive reaction best possible stop (BD1) or user-defined stop (BD2).
