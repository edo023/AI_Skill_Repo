...
The value for the current feed forward (CurrFeedForward) is calculated from the acceleration. The moment of inertia with the parameters J\_Load, GearIn, GearOut, and J\_Gear taken into account in this calculation.
