...
MechVelocity represents the actual velocity, which is derived from the position [MechPosition](RefActualValues-8.htm#XREF_D_SE_0071499_1), in units per second. It is taken from the drive shaft (gear box output side). The [YOffsetVelocity](../YOffsetGenerator_2/YOffsetGenerator_2-6.htm#XREF_D_SE_0071852_1) from the Y offset generator is taken into account (see [Ref-Actual Values](RefActualValues-1.htm#XREF_D_SE_0071489_1)).
...
Relative to the speed at the drive shaft, the MechVelocity is delayed by the time [ShaftDelay](RefActualValues-9.htm#XREF_D_SE_0071500_1). Therefore, a velocity including YOffsetVelocity is represented that is delayed by the drive shaft by the ShaftDelay time.
