...
NOTE: Before entering ControllerStopDec, verify the parameters [MaxVel](General_2-2.htm#XREF_D_SE_0071523_1), [MaxAcc](General_2-4.htm#XREF_D_SE_0071526_1), and [StopTimeLim](General_2-9.htm#XREF_D_SE_0071531_1). Changing these parameters at a later stage does not influence Controller­StopDec. However, when reducing ControllerStopDec , the time and the necessary position range for a stop increases.
...
o[ControllerEnable](../State_2/State_2-9.htm#XREF_D_SE_0071477_1) is switched off and [ControllerEnableStopMode](../State_2/State_2-7.htm#XREF_D_SE_0071430_1) is set to "UserDefinedStop / 0" (default value) or
