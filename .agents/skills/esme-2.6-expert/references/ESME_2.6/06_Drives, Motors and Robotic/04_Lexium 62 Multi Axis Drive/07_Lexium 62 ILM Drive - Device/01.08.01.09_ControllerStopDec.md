...
| NOTICE | |
| --- | --- |
|  | MECHANICAL COLLISION OF MACHINE PARTS  Set the value for ControllerStopDec such that there is enough position range for a collision-free stop.  Failure to follow these instructions can result in equipment damage. |
