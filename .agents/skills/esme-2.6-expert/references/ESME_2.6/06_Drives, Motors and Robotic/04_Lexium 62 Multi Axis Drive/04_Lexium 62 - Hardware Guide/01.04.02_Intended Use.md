...
If circumstances occur that affect the safety or cause changes to the operating behavior of the Lexium 62 components, then immediately shut down the Lexium 62 components and contact your Schneider Electric representative.
...
There are no user-serviceable parts in the Lexium 62 Drive System. Do not attempt to modify the Lexium 62 Drive System in any way. Refer to Schneider Electric for all repairs and replacements.
