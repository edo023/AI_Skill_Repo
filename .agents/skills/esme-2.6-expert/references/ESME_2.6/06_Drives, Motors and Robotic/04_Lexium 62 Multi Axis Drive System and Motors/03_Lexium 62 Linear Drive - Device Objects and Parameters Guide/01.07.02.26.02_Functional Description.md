...
The parameter represents the ControlBoard temperature in °C. This temperature is measured with a temperature sensor on the control board of the device. The diagnostic messages 8161 Control board temperature high and 8142 Control board overtemperature are triggered by this temperature. The maximum control board temperature is defined in the DeviceTypePlate. The advisory limit is 3 degrees Celsius below the error limit.
