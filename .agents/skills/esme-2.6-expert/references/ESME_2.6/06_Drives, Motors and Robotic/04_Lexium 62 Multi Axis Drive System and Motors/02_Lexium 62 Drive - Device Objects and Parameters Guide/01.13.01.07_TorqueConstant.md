...
The parameter represents the torque constant of the motor [Nm/A] (is read from the motor encoder) for low currents. For currents above the rated current, the torque constant reduces due to saturation effects in the motor. This effect is taken into account when calculating the maximum acceleration MaxAcc.
