...
| NOTICE | |
| --- | --- |
|  | POSITION JUMPS WHEN THE GENERATOR IS ACTIVATED OR DEACTIVATED  * Enable the function only once when initializing. * Disable the function only in exceptional cases.  Failure to follow these instructions can result in equipment damage. |
