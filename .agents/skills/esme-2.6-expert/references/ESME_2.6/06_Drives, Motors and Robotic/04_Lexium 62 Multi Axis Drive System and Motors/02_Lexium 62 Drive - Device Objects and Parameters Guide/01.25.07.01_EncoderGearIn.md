...
The EncoderGearIn / EncoderGearOut parameters describe a gear factor between machine encoder and load. This gear factor can be different from the gear factor between motor and load (parameter GearIn / GearOut).
