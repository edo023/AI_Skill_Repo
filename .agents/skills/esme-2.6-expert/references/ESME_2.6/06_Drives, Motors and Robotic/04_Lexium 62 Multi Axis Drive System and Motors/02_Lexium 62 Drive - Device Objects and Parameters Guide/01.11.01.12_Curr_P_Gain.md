...
The parameter represents the proportional gain of the controller. 100 % is the default value in relation to the motor inductance.
...
Exception: If a small motor (low peak current) is connected to a large device (high peak current), the occurring current ripple may cause radiated interference. In this case, the parameters Curr\_P\_Gain and Curr\_I\_Gain can be reduced.
