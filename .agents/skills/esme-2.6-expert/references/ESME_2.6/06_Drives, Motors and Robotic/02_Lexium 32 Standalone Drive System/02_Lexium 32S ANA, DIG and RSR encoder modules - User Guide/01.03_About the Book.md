...
The functions described in this user guide are only intended for use with the associated product. You must read and understand the appropriate user guide of the drive.

## Validity Note

This user guide applies to the encoder modules for the servo drive LXM32S, module identification ANA (VW3M3403), DIG (VW3M3402) and RSR (VW3M3401).
...
| --- | --- |
| LXM32S - ANA, DIG and RSR Encoder Modules - User Guide (this user guide) | [EIO0000003981 (eng)](https://www.se.com/ww/en/download/document/EIO0000003981)  [EIO0000003982 (fre)](https://www.se.com/ww/en/download/document/EIO0000003982)  [EIO0000003983 (ger)](https://www.se.com/ww/en/download/document/EIO0000003983) |
