...
| Follow the installation instructions such that the condensation from the cooling unit can not enter electronic components. |
| Failure to follow these instructions can result in death, serious injury, or equipment damage. |

Installing a cooling unit

![G-SE-0042284.1.gif-high.gif](images/G-SE-0042284.1.gif-high.gif)