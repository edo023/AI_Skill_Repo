...
With real axes, the UserMaxVel can be set maximum to the value that corresponds to the maximum motor rotational speed [MaxSpeed](../../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Parameter.LXM52Drive&topicID=D_SE_0071784_1)  [RPM]. With the UserMaxVel parameter, the maximum velocity [MaxVel](General_2-2.htm#XREF_D_SE_0071523_1), determined by the system, can be limited. This parameter defines the machine-specific value of MaxVel.
