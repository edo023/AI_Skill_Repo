...
Is used to enter the viscous direction-dependent friction from the motor and load Newton per 1000 units per second [N / (1000 units/s)]. The viscose friction is a force that changes proportionally to the reference velocity of the motor and works in the opposite direction of the motor movement.
