...
NOTE: In the case of a loose coupling (belts, chains, ...) it is better to set [VelFilter](ControlLoop_2-7.htm#XREF_D_SE_0071567_1) and CurrRefFilter to 0 and, if necessary, to reduce the speed controller parameters ([Vel\_P\_Gain](ControlLoop_2-5.htm#XREF_D_SE_0071565_1) and [Vel\_I\_Gain](ControlLoop_2-6.htm#XREF_D_SE_0071566_1)) as well.
