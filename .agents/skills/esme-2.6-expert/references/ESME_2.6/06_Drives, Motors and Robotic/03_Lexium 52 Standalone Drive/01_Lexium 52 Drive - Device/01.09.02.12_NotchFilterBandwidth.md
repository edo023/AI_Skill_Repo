...
Is used to enter the bandwidth of the NotchFilter in the velocity control loop for -3 dB in Hz (hertz).

There is a damping of at least 3 dB within the bandwidth. The [NotchFilterFrequency](ControlLoop_2-10.htm#XREF_D_SE_0071572_1), at which the maximum damping [NotchFilterDamping](ControlLoop_2-9.htm#XREF_D_SE_0071571_1) is reached, lies in the center of this spectrum.
