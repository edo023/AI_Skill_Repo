...
Is used to enter the time constant of a first order low pass filter in the velocity control loop in ms. The filter affects the [actual velocity](../RefActualValues/RefActualValues-14.htm#XREF_D_SE_0071516_1) in the feedback of the [velocity controller circuit](ControlLoop_2-1.htm#XREF_D_SE_0071560_1). Using this filter, high frequency oscillations can be suppressed which may occur for example, in the case of a two-mass oscillator with rigid coupling.
...
NOTE: In the case of a loose coupling (belts, chains, ...) it is better to set VelFilter and CurrRefFilter to 0 and, if necessary, to reduce the velocity controller parameters ([Vel\_P\_Gain](ControlLoop_2-5.htm#XREF_D_SE_0071565_1) and [Vel\_I\_Gain](ControlLoop_2-6.htm#XREF_D_SE_0071566_1)) as well.
