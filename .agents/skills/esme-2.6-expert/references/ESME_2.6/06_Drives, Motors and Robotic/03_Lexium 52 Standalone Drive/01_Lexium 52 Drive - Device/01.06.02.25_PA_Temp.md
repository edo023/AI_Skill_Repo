...
Displays the power stage temperature in °C. This temperature is measured with a temperature sensor on the power stage of the device. The diagnostic messages 8126 Power stage temperature high and 8101 Power Stage overtemperature are triggered by this temperature. The maximum power stage temperature is defined in the device type plate. The warning limit is also defined in the device type plate from device type plate version 25 or higher. Otherwise it is defined 10 degrees Celsius below the error limit.
