...
With real axes, the UserMaxVel can be set maximum to the value that corresponds to the maximum motor rotational speed [MaxSpeed](../Motor_2/Motor_2-7.htm#XREF_D_SE_0071784_1)  [RPM]. With the UserMaxVel parameter, the maximum velocity [MaxVel](General_2-2.htm#XREF_D_SE_0071523_1), determined by the system, can be limited. This parameter defines the machine-specific value of MaxVel.
...
NOTE: Modifications to the parameter are only applied during the Sercos phase up (communication phase 0 => communication phase 4). The maximum user speed is not supervised for induction motors without encoder (in open-loop V / f control mode, [ControlMode](../ControlLoop_2/ControlLoop_2-2.htm#XREF_D_SE_0071561_1) = open-loop control / 1).
