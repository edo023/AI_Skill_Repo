...
Displays the status of the servo amplifier.

| Value | Data type | Meaning |
| --- | --- | --- |
| Not ready / 0 | DINT | Drive is not ready to be switched on.  Possibly the parameter [MotorIdentification](../../../../../../api/crossBook?lang=en-US&virtualBookName=PD.Parameter.LXM52Drive&topicID=D_SE_0071763_1) is set to motorless / 1.  Drives with external power supply (for example, LXM62DxS or Lexium 62 ILM): waiting for object parameter PowerSupplyCheck = TRUE of the corresponding power supply. |
...
![G-SE-0061392.1.gif](images/G-SE-0061392.1.gif)