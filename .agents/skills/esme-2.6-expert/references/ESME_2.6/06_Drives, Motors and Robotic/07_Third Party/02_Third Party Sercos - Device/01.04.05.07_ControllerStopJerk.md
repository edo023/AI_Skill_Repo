...
ControllerStopJerk contains the absolute value in units/s3 with which the drive is stopped. The value is effective with [ControllerStop](../State/State-10.htm#XREF_D_SE_0071453_1) and with the drive reaction BD2 (User defined stop). The user parameter is used to define the jerk for decelerating the axis. The jerk defines how fast the acceleration is increased or decreased.
...
NOTE: Before entering ControllerStopJerk, verify the parameters [MaxAcc](../../../../../../api/crossBook?lang=en-US&virtualBookName=General-4.htm#XREF_D_SE_0071526_1) and [StopTimeLim](../../../PD.Parameter.LXM52LinearDrive&topicID=D_SE_0071531_1). Changing these parameters at a later stage does not influence ControllerStopJerk.
...
NOTE: The parameters [ControllerStopDec](General-6.htm#XREF_D_SE_0071532_1), [ControllerStopJerk](#XREF_D_SE_0071533_1), and [ControllerStopSet](../State/State-9.htm#XREF_D_SE_0071452_1) are supported as of V1.35.1.5 from the Sercos Drive. As of this version the Sercos Drive also implements the interface IF\_ControllerStop.
