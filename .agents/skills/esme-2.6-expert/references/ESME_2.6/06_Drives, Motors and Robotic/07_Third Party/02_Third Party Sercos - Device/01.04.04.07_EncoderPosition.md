...
Relative to the actual position at the drive shaft, the position is delayed by the time [ShaftDelay](RefActualValues-14.htm#XREF_D_SE_0071500_1). Thus, a position within the encoder range is displayed that is delayed to the drive shaft by the ShaftDelay time.
