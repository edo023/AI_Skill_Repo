...
The load case  Roll feed is applicable for feeding flat material, for example, for transporting foils or plates.

## Parameters

The load case Roll feed  allows you to specify the parameters described in the table:

![](images/T001605924.gif)

**1** Input shaft

**2** Rotary motion at the input shaft

**3** Load: foil or plate

**4** Drive roll

**5** Driven roll

**6** Linear movement of the load described by the motion profile
...
| Mass of the load | Mass of the material that is transported through the rolls. | Mass |
...
| Material tension force | Additional tension force that depends on the material of the load that is the foil or plate in this application (legend item 3 in the graphic above this table). | Force |
...
| Selected motion profile | The motion profile that is used a a basis for calculations for this axis.  The motion profile of the load case Roll feed  describes a linear movement of the load that is the foil or plate in this application (legend item 3 in the graphic above this table). | Linear motion |
