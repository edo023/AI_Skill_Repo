...
This document describes the SQL Gateway Windows service application and the corresponding user interface, the SQL Gateway Console. The SQL Gateway serves as an interface for SQL communication between controllers and SQL databases.

It is assumed that you have detailed knowledge on the database type you intend to connect to.
...
Refer to the following topics in this user guide:
...
* English ([EIO0000002417](https://www.se.com/ww/en/download/document/EIO0000002417))
* French ([EIO000002418](https://www.se.com/ww/en/download/document/EIO000002418))
* German ([EIO000002419](https://www.se.com/ww/en/download/document/EIO000002419))
* Italian ([EIO000002420](https://www.se.com/ww/en/download/document/EIO000002420))
* Spanish ([EIO000002421](https://www.se.com/ww/en/download/document/EIO000002421))
* Chinese ([EIO000002422](https://www.se.com/ww/en/download/document/EIO000002422))
...
| EcoStruxure Machine Expert SqlRemoteAccess Library Guide | [EIO0000002767 (ENG)](https://www.se.com/en/download/document/EIO0000002767) |
